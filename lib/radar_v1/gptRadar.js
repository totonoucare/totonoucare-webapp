...
- 各項目は1文で、合計3文にしてください
  1項目目: 明日なぜ注意か
  2項目目: 今日(特に今夜)のうちにしておくとよい備えや意識
  3項目目: 明日当日の過ごし方
- 前置きやまとめは書かず、箇条書き本文だけを書いてください
`
      : `
# today の役割
- ユーザーは対象日をすでに迎えています
...
- 1項目目では、
  ...
  の順で書く
- 2項目目は必ず「今夜は」で始め、前夜の準備を書く
- 3項目目は必ず「この日は」または「日中は」で始め、対象日当日の過ごし方を書く
...
- 1項目目では、
  気象の主な変化 → その人に一番響きやすい要素 → 主訴へのつながり
  の順で書く
- 2項目目は必ず「この日は」または「日中は」で始め、その日全体の過ごし方を書く
- target_date_label は1項目目にだけ入れる
- 各項目は必ず「・」で始める
- 文はスマホで読みやすい長さにする
`;
