...
export async function upsertPrimaryRadarLocation({
  ...
  if (regionName !== undefined) payload.region_name = regionName || null;
...
export async function saveForecast({
  ...
  const row = {
    ...
    gpt_summary: radarPlan.forecast.gpt_summary || "",
    gpt_model: radarPlan.forecast.gpt_model || null,
    gpt_generated_at: radarPlan.forecast.gpt_generated_at || null,
    vendor,
