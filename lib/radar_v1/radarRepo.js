...
import { projectForecastStorageCompat } from "@/lib/radar_v1/forecastStorageCompat";
...
export async function saveForecast({
  ...
  const supabase = getServiceSupabase();
  const storageCompat = projectForecastStorageCompat(radarPlan.forecast);
  ...
  const row = {
    ...
    main_trigger: storageCompat.main_trigger,
    trigger_dir: storageCompat.trigger_dir,
    ...
    computed: {
      ...
      forecast_storage_compat: {
        ...storageCompat,
        source_main_trigger: radarPlan.forecast.main_trigger || null,
        source_trigger_dir: radarPlan.forecast.trigger_dir || null,
      },
    },
    updated_at: new Date().toISOString(),
  };
