...
export const RADAR_FORECAST_MODEL_VERSION = "radar_forecast_v2_2026-07-28_moisture_state_direction";
...
function emptyTriggerFactor(weatherStress, pressureResponseDirection = "balanced") {
  const exact = (
      weatherStress?.pressure_presentation_direction || weatherStress?.pressure_direction
  ...
  return {
    exact,
    direction: weatherStress?.pressure_direction || "steady",
    physical_direction: weatherStress?.pressure_direction || "steady",
    response_direction: pressureResponseDirection,
    body_response_key: `pressure_${pressureResponseDirection}`,
  };
}
