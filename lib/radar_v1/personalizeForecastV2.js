...
export const RADAR_FORECAST_MODEL_VERSION = "radar_forecast_v2_2026-07-21_constitution_hierarchy";
...
export function personalizeForecastV2({ weatherStress, constitution }) {
  ...
  const affinityProfile = buildAffinities(profile, weatherStress);
