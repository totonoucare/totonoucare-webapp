...
export function buildRadarPlan({
  ...
  return {
    forecast: {
      ...
      pressure_direction: riskContext.summary.pressure_direction || riskContext.weather_context?.pressure_direction || null,
      moisture_state: riskContext.summary.moisture_state || riskContext.weather_context?.moisture_state || null,
      pressure_response_direction: riskContext.summary.pressure_response_direction || null,
      ...
      material_ranking: riskContext.summary.material_ranking || [],
      weather_load_groups: riskContext.summary.weather_load_groups || null,
      environmental_cautions: riskContext.summary.environmental_cautions || [],
      channel_peaks: riskContext.summary.channel_peaks || riskContext.weather_context?.channel_peaks || null,
