...
function buildPrimaryTriggerContract(exact, riskContext) {
  ...
  return {
    ...
    rule: "文章の主因は必ず forecast.personal_main_trigger_exact / this_contract.primary_exact に合わせる。気圧では上昇・低下を物理情報、pressure_response_directionを体への表れ方として分け、物理方向から張り・重さを決め直さない。副因がある場合だけ補助要素として添える。",
  };
}
