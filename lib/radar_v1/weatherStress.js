 ...
 * - daily channel strengths use rolling windows, including slower 24h shifts.
 * - peak-time detection uses short/local windows only, so it does not mistake
 *   same-time day-over-day differences for an intraday peak.
 */
...
export function buildWeatherStress({ points, contextPoints = null }) {
  ...
  return {
    ...
    meta: {
      extraction_version: "radar_v1_weather_context_rolling_peakfix_2026-04-24",
