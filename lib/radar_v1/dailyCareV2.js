import { FOOD_ITEMS, buildTcmFoodPlan } from "./foodTcm";
import { buildDrinkActionCard } from "./drinkRules";
export { FOOD_ITEMS };
...
export const DAILY_CARE_LOGIC_VERSION = "daily_care_v2_35_2026-09-21_food_context_audit";
...
// Scene restrictions require an explicit choice; symptom matches alone do not unlock them.
export const LIFESTYLE_SCENES = [
  { key: "general", label: "日常・休む時" }, { key: "desk", label: "机・椅子" },
  { key: "screen", label: "スマホ・読書" }, { key: "carry", label: "物を持つ時" },
  { key: "sleep", label: "寝る前" },
];
const LIFESTYLE_USAGE = {
  "tool-bath-or-footbath": { equipment: "浴槽・足湯の容器", scenes: ["sleep"] },
  "tool-arm-support": { equipment: "机", scenes: ["desk"] },
  "tool-screen-height": { equipment: "安定した台", scenes: ["screen"] },
  "tool-foot-support": { equipment: "安定した足台", scenes: ["desk"], restricted: true },
  "tool-back-support": { equipment: "タオル・背もたれ", scenes: ["desk"] },
  "tool-leg-rest": { equipment: "薄いクッション", scenes: ["general", "sleep"] },
  "tool-side-sleep-support": { equipment: "枕またはタオル", scenes: ["general", "sleep"] },
  "tool-facing-layout": { equipment: "画面の配置", scenes: ["desk"], restricted: true },
  "tool-light-zone": { equipment: null, scenes: ["general", "sleep"] },
  "tool-sound-zone": { equipment: null, scenes: ["general", "sleep"] },
  "tension-open-palm-carry": { equipment: null, scenes: ["carry"] },
  "tension-load-to-ground": { equipment: null, scenes: ["carry"] },
  "tension-phone-thumb-line": { equipment: null, scenes: ["screen"] },
  "tension-inner-ankle-stand": { equipment: null, scenes: ["general"] },
  "tension-seated-foot-head": { equipment: null, scenes: ["general", "desk"] },
  "tension-sit-stand-innerline": { equipment: null, scenes: ["general", "desk"] },
  "tension-bed-long-roll": { equipment: null, scenes: ["general", "sleep"] },
};

const ENVIRONMENT_ADJUSTMENT_CANDIDATES = [
{
  "id": "tool-bath-or-footbath",
  "care_kind": "environment",
  "kind_label": "環境調整",
  "scene_family": "warm_with_bath",
  "scene_label": "湯で温める",
  "scene": "今夜、冷えが気になる時",
  "text": "ぬるめのお湯に短時間つかる。湯船が負担なら足湯を選ぶ。",
  "reason": "冷えを感じる時に、無理のない温まり方を選ぶためです。",
  "felt_sense": "熱さやのぼせを感じずに過ごせるか。",
  "reset": "熱さやのぼせを感じたら、お湯から上がる。",
  "symptoms": [
    "fatigue",
    "sleep",
    "digestion",
  ...
  "effort": "medium",
  "score_adjustment": -2,
  "headline": "ぬるめのお湯に短時間つかる。湯船が負担なら足湯を選ぶ。",
  "conditional": true
},
  {
    "id": "tool-arm-support",
    ...
    "scene": "机で作業する時",
    "text": "ひじから手首までを机に軽く乗せ、腕の重さを預ける。",
    "reason": "腕を机で支えた時の、首肩の力の入り方を比べるためです。",
    "felt_sense": "腕を預ける前後で、肩を持ち上げている感じが変わるか。",
    "reset": "肩が上がる時は、椅子や机との位置を調整する。",
    "symptoms": [
      "neck_shoulder",
      "headache",
      "fatigue"
    ...
    "care_needs": [
      "support_arm_weight",
      "reduce_static_tension"
    ],
    "item_role": "forearm_support",
    "shop_eligible": true,
    "effort": "low",
    "headline": "ひじから手首までを机に軽く乗せ、腕の重さを預ける。",
    "modes": [
      "today",
      "tomorrow"
    ]
  },
  {
    ...
    "scene": "スマホや本を見る時",
    "text": "スマホや本を台に置き、首を深く曲げずに読める高さへ上げる。",
    "reason": "読む間の首の曲がり方を調整するためです。",
    "felt_sense": "画面を見る時、首を前へ突き出したり、あごを上げたりしていないか。",
    "reset": "見えにくい時は、文字の大きさや台との距離も調整する。",
    "symptoms": [
      "neck_shoulder",
      "headache",
      "dizziness",
    ...
    "constitution_affinity": {
      "accel": 0.9,
      "qi_stagnation": 0.65,
      "fluid_deficiency": 0.35
    },
    "care_needs": [
      "reduce_viewing_reach",
      "reduce_static_tension"
    ],
    "item_role": "screen_height",
    "shop_eligible": true,
    "effort": "low",
    "headline": "スマホや本を台に置き、首を深く曲げずに読める高さへ上げる。",
    "modes": [
      "today",
      "tomorrow"
    ],
    "symptom_copy": {
      "digestion": {
        "scene": "座って本や画面を見る時",
        "text": "本や画面を台に置き、お腹を折り曲げるほど前かがみにならずに読める高さにする。",
        "headline": "本や画面を台に置き、お腹を折り曲げるほど前かがみにならずに読める高さにする。",
        "felt_sense": "読む時に、お腹が窮屈になっていないか。",
        "reason": "読む姿勢による、お腹まわりの窮屈さを比べるためです。"
      }
    }
  },
  {
    ...
    "scene_label": "足裏を預ける",
    "scene": "椅子に座ると足が床に届かない時",
    "text": "足元に安定した台を置き、足裏全体を乗せる。",
    "reason": "足が浮いたままの座り方と比べるためです。",
    "felt_sense": "足裏を支える前後で、座りやすさが変わるか。",
    "reset": "膝がお腹へ近づきすぎる時は、台を低くする。",
    "symptoms": [
      "low_back_pain",
      "fatigue",
      "swelling",
    ...
    "care_needs": [
      "support_seated_contact",
      "distribute_load"
    ],
    "item_role": "sitting_support",
    "shop_eligible": true,
    "effort": "low",
    "headline": "足元に安定した台を置き、足裏全体を乗せる。",
    "modes": [
      "today",
      "tomorrow"
    ]
  },
  {
    ...
    "scene_label": "光の入口を絞る",
    "scene": "眠る前に光がまぶしく感じる時",
    "text": "部屋の照明を少し暗くし、まぶしさを比べる。",
    "reason": "休む時の光の入り方を調整するためです。",
    "felt_sense": "目を細めずに、手元や足元が見える明るさか。",
    "reset": "手元や足元が見えにくい時は、必要な場所の明かりを戻す。",
    "symptoms": [
      "headache",
      "sleep",
      "mood"
    ...
    "constitution_affinity": {
      "accel": 1,
      "qi_stagnation": 0.65,
      "fluid_deficiency": 0.3
    },
    "care_needs": [
      "reduce_sensory_input",
      "reduce_visual_load"
    ],
    "item_role": "reduce_light",
    "shop_eligible": true,
    "effort": "low",
    "headline": "部屋の照明を少し暗くし、まぶしさを比べる。",
    "modes": [
      "today",
      "tomorrow"
    ],
  ...
  },
  {
    ...
    "scene": "背もたれのある椅子に座る時",
    "text": "腰と背もたれの隙間に薄く丸めたタオルを入れ、背中を預ける。",
    "reason": "背もたれに身体を預けやすい位置を探すためです。",
    "felt_sense": "腰が押されすぎず、お腹も窮屈にならずに座れるか。",
    "reset": "腰が押される時はタオルを薄くするか外す。",
    "symptoms": [
      "low_back_pain",
      "fatigue",
      "digestion"
    ...
    "shop_eligible": true,
    "effort": "low",
    "headline": "腰と背もたれの隙間に薄く丸めたタオルを入れ、背中を預ける。",
    "modes": [
      "today",
      "tomorrow"
    ]
  },
  {
    ...
    "scene_label": "脚を面で預ける",
    "scene": "あお向けで脚を休める時",
    "text": "膝の下からふくらはぎにかけて、薄いクッションを敷く。",
    "reason": "脚を支える場所を変え、休みやすさを比べるためです。",
    "felt_sense": "膝裏やかかとの一か所だけが強く当たっていないか。",
    "reset": "膝や腰が落ち着かない時は、クッションを薄くするか外す。",
    "symptoms": [
      "swelling",
      "fatigue",
      "sleep"
    ...
    "care_needs": [
      "support_leg_weight",
      "change_sleep_surface"
    ],
    "item_role": "leg_support",
    "shop_eligible": true,
    "effort": "low",
    "headline": "膝の下からふくらはぎにかけて、薄いクッションを敷く。",
    "modes": [
      "today",
      "tomorrow"
    ]
  },
  {
    ...
    "scene": "横向きで休む時",
    "text": "両膝の間に薄い枕や折ったタオルを挟み、上側の脚を支える。",
    "reason": "上側の脚の置き場を作り、横向きの姿勢を比べるためです。",
    "felt_sense": "支えを入れる前後で、腰がねじれる感じが変わるか。",
    "reset": "股関節が窮屈な時は、支えを薄くするか外す。",
    "symptoms": [
      "sleep",
      "low_back_pain",
      "neck_shoulder"
    ...
    "effort": "low",
    "headline": "両膝の間に薄い枕や折ったタオルを挟み、上側の脚を支える。"
  },
  {
    ...
    "scene": "横の画面を見るたびに頭を動かしている時",
    "text": "よく見る画面を、身体の正面から確認しやすい位置へ寄せる。",
    "reason": "頭を何度も動かす配置を見直すためです。",
    "felt_sense": "画面を見る時、首を大きくひねらずに済むか。",
    "reset": "見づらくなった時は元の位置へ戻し、椅子の向きで調整する。",
    "symptoms": [
      "dizziness",
      "headache",
      "neck_shoulder"
    ...
    "shop_eligible": true,
    "effort": "low",
    "headline": "よく見る画面を、身体の正面から確認しやすい位置へ寄せる。",
    "modes": [
      "today",
      "tomorrow"
    ],
  ...
  },
  {
    ...
    "scene": "テレビ・音楽・通知音が重なっている時",
    "text": "見ていないテレビや聴いていない音楽を一つ消す。",
    "reason": "重なっている音を減らし、過ごしやすさを比べるためです。",
    "felt_sense": "一つ消す前後で、音の気になり方が変わるか。",
    "reset": "静かすぎて落ち着かない時は、小さな音を一つ戻す。",
    "symptoms": [
      "mood",
      "sleep",
      "headache"
    ...
    "shop_eligible": true,
    "effort": "low",
    "headline": "見ていないテレビや聴いていない音楽を一つ消す。",
    "modes": [
      "today",
      "tomorrow"
    ],
...
// 公開する動作と選定用メタデータを一緒に管理する。継続する動作のIDを維持する。
const BODY_MECHANICS_LIFESTYLE_CANDIDATES = [
  {
    "id": "tension-open-palm-carry",
    "scene_family": "hold_carry",
    "scene": "軽いコップなどを持つ時",
    "headline": "手のひらで包むように持ち、指に力を入れすぎないようにする。",
    "text": "手のひらで包むように持ち、指に力を入れすぎないようにする。",
    "reason": "指先だけで強く握り続けていないかを確かめるためです。",
    "felt_sense": "指や手首に余計な力が入っていないか。",
    "reset": "滑りそうな時は両手で持つか、いつもの持ち方へ戻す。",
    "symptoms": [
      "neck_shoulder",
      "fatigue"
    ],
  ...
  },
  {
    ...
    "scene_family": "hold_carry",
    "scene": "荷物を両手で持つ時",
    "headline": "荷物をお腹の前で身体に近づけてから歩き出す。",
    "text": "荷物をお腹の前で身体に近づけてから歩き出す。",
    "reason": "荷物と身体の距離による、持ちやすさの違いを比べるためです。",
    "felt_sense": "近づける前後で、腕や肩の力の入り方が変わるか。",
    "reset": "向きを変える時は足を踏み替え、身体ごとその方向へ向く。重い時はいったん置く。",
    "symptoms": [
      "fatigue",
      "neck_shoulder",
      "low_back_pain",
  ...
  },
  {
    ...
    "scene": "スマホを操作する時",
    "headline": "反対の手でもスマホを下から支える。親指を遠くへ伸ばす時は、持つ位置を変える。",
    "text": "反対の手でもスマホを下から支える。親指を遠くへ伸ばす時は、持つ位置を変える。",
    "reason": "片手だけで持つ時との、操作しやすさを比べるためです。",
    "felt_sense": "支える前後で、親指や手首の力みが変わるか。",
    "reset": "手が疲れる時は、スマホを机に置いて操作する。",
    "symptoms": [
      "neck_shoulder",
      "headache"
    ],
  ...
  },
  {
    ...
    "scene": "立っている時",
    "headline": "かかとの少し前あたりに体重を乗せ、足指の力を抜いてみる。",
    "text": "かかとの少し前あたりに体重を乗せ、足指の力を抜いてみる。",
    "reason": "立っている間に、足指で踏ん張り続けていないかを確かめるためです。",
    "felt_sense": "足指を軽く動かせるか。",
    "reset": "ふらつく時は試すのをやめ、安定した姿勢に戻す。",
    "symptoms": [
      "low_back_pain",
      "fatigue",
      "swelling",
  ...
  },
  {
    ...
    "scene_family": "hold_posture",
    "scene": "座り直す時",
    "headline": "両足裏を床につけ、お尻を左右に小さく動かして座る位置を探す。",
    "text": "両足裏を床につけ、お尻を左右に小さく動かして座る位置を探す。",
    "reason": "座る位置による、体重のかかり方の違いを確かめるためです。",
    "felt_sense": "片側だけに寄らず、両側のお尻で座っている感じがあるか。",
    "reset": "足が床に届かない時は、安定した足台を使う。",
    "symptoms": [
      "low_back_pain",
      "fatigue",
      "digestion"
  ...
  },
  {
    ...
    "scene": "椅子から立つ時",
    "headline": "足を膝の下あたりへ引き、上半身を少し前に傾けてから立ち上がる。",
    "text": "足を膝の下あたりへ引き、上半身を少し前に傾けてから立ち上がる。",
    "reason": "足へ体重を乗せてから立ち上がる動きを試すためです。",
    "felt_sense": "立ち上がる時に、かかとが浮いていないか。",
    "reset": "立ちにくい時は、肘掛けなどの安定した支えを使う。",
    "symptoms": [
      "low_back_pain",
      "fatigue"
    ],
  ...
  },
  {
    ...
    "scene": "あお向けから寝返る時",
    "headline": "両膝を曲げ、膝を横へ倒すのに合わせて顔と肩も同じ方向へ向ける。",
    "text": "両膝を曲げ、膝を横へ倒すのに合わせて顔と肩も同じ方向へ向ける。",
    "reason": "膝と肩を同じ方向へ動かした時の、寝返りやすさを比べるためです。",
    "felt_sense": "腰だけをひねる感じが、いつもの寝返りと比べてどうか。",
    "reset": "痛みや引っかかりがある時は試すのをやめ、楽な姿勢に戻す。",
    "symptoms": [
      "sleep",
      "low_back_pain",
      "neck_shoulder"
...
const RESPONSE_MEAL_CATALOG = [
  mealCandidate("calm-simple-tofu-greens", "豆腐と冷凍ほうれん草のスープ＋ごはん", "豆腐と冷凍野菜をだしで温めるだけ。味つけは薄めにします。", ["shizumeru", "uruosu", "yurumeru"], ["calm", "moist", "quick", "digestion"], "和食", "tofu", "soup", { effort: "low" }),
  mealCandidate("warm-simple-egg-udon", "卵とねぎの温かいうどん", "冷凍うどんに卵と刻みねぎを加え、やわらかく煮ます。", ["nukumeru", "sasaeru", "yurumeru"], ["warm", "support", "quick", "digestion"], "和食", "egg", "noodle", { effort: "low", avoid_triggers: ["heat"] }),
  mealCandidate("move-simple-tuna-rice", "ツナとしその混ぜごはん", "ごはんにツナとしそを混ぜます。缶の油は軽く切り、しょうゆは少量に。", ["meguraseru", "sasaeru", "yurumeru"], ["aroma", "support", "quick"], "和食", "fish", "rice", { effort: "low" }),
  mealCandidate("light-simple-chicken-cabbage", "鶏肉とキャベツのレンジ蒸し＋ごはん", "食べやすく切った鶏肉とキャベツを蒸し、肉の中心まで火を通します。", ["nagasu", "shizumeru", "sasaeru"], ["light", "support", "quick", "calm"], "和食", "chicken", "plate", { effort: "low" }),
  mealCandidate("warm-simple-ginger-tofu", "豆腐ときのこの生姜スープ＋ごはん", "豆腐ときのこをだしで煮て、生姜を少量添えます。", ["nukumeru", "meguraseru", "nagasu"], ["warm", "aroma", "light", "quick"], "和食", "tofu", "soup", { effort: "low", avoid_triggers: ["heat", "dry"] }),
  mealCandidate("moist-simple-egg-rice", "卵と冷凍野菜の雑炊", "ごはんと冷凍野菜をだしで煮て、卵を加えて火を通します。", ["uruosu", "sasaeru", "yurumeru"], ["moist", "support", "digestion", "quick"], "和食", "egg", "rice", { effort: "low" }),
...
const MERIDIAN_LINE_CARE = {
  lung_li: [
    {
      id: "line-lung-li-clavicle-stroke",
      line_id: "line-lung-li",
      title: "鎖骨の下を肩先へなでる",
      action: "片手を反対側の鎖骨の下へ当て、胸の中央側から肩先へゆっくり3回なでます。左右を順番に行います。",
      reason: "呼吸が浅く、首肩に力が集まりやすい日に、鎖骨まわりへ軽く触れるケアです。",
      care_kind: "stroke",
    },
    {
      id: "line-lung-li-chest-breath",
      line_id: "line-lung-li",
      title: "胸に手を置いて6呼吸",
      action: "椅子に座り、片手を胸の中央へ置きます。肩を持ち上げず、吐く息を少し長くして6呼吸します。",
      reason: "肩で息をしている感じがある日に、上半身の力みを確認しながら行います。",
      care_kind: "breath",
    },
    {
      id: "line-lung-li-thumb-forearm-stroke",
      line_id: "line-lung-li",
      title: "前腕の親指側をなでる",
      action: "反対の手で、肘の内側から手首の親指側へゆっくり3回なでます。左右を順番に行います。",
      reason: "胸まわりへ直接触れにくい時にも行える、腕側からのケアです。",
      care_kind: "stroke",
    },
  ],
  heart_si: [
    {
      id: "line-heart-si-little-finger-stroke",
      line_id: "line-heart-si",
      title: "腕の小指側をなでる",
      action: "反対の手で、肩の下から手首の小指側へゆっくり3回なでます。左右を順番に行います。",
      reason: "頭を使い続けて、肩から腕まで張る感じがある日に向くケアです。",
      care_kind: "stroke",
    },
    {
      id: "line-heart-si-scapula-contact",
      line_id: "line-heart-si",
      title: "肩甲骨の外側へ手を当てる",
      action: "反対の手を脇の後ろへ回し、届く範囲で肩甲骨の外側へ手のひらを当てます。そのまま3呼吸します。",
      reason: "背中の外側に力が残っている時に、強く押さずに触れるケアです。",
      care_kind: "hand_contact",
    },
    {
      id: "line-heart-si-shoulder-roll",
      line_id: "line-heart-si",
      title: "両肩を後ろへ5回回す",
      action: "両肩をすくめず、後ろ向きに小さな円を描くように5回回します。",
      reason: "画面や作業で肩が前へ入り続けた時に、座ったままできる動きです。",
      care_kind: "movement",
    },
  ],
  kidney_bl: [
    {
      id: "line-kidney-bl-low-back-contact",
      line_id: "line-kidney-bl",
      title: "腰へ手のひらを当てる",
      action: "椅子に座るか立ったまま、腰の左右へ手のひらを当てます。押し込まず、そのまま10秒触れます。",
      reason: "冷えや疲れが腰へ集まる感じがある日に、刺激を加えすぎず触れるケアです。",
      care_kind: "hand_contact",
    },
    {
      id: "line-kidney-bl-calf-stroke",
      line_id: "line-kidney-bl",
      title: "ふくらはぎの後ろをなでる",
      action: "椅子に座って片脚を少し前へ出し、膝下から足首へ向かって、ふくらはぎの後ろを5回なでます。左右を順番に行います。",
      reason: "脚の後ろ側へ重さが残る日に、痛くない強さで行います。",
      care_kind: "stroke",
    },
    {
      id: "line-kidney-bl-toe-lift",
      line_id: "line-kidney-bl",
      title: "つま先を5回上げる",
      action: "椅子に座り、かかとは床につけたまま、両足のつま先をゆっくり上げて戻します。5回繰り返します。",
      reason: "座ったまま、ふくらはぎから足首を軽く動かしたい時の一手です。",
      care_kind: "movement",
    },
  ],
  liver_gb: [
    {
      id: "line-liver-gb-side-breath",
      line_id: "line-liver-gb",
      title: "脇腹に手を当てて5呼吸",
      action: "椅子に座り、片手を脇腹へ当てます。手に触れる部分がゆっくり動くのを感じながら5呼吸し、反対側も行います。",
      reason: "緊張して呼吸が胸だけになっている時に、体側の動きを確認するケアです。",
      care_kind: "breath",
    },
    {
      id: "line-liver-gb-outer-thigh-stroke",
      line_id: "line-liver-gb",
      title: "外ももを膝へ向かってなでる",
      action: "椅子に座り、腰骨の下から膝の外側へ向かって、外ももを手のひらで5回なでます。左右を順番に行います。",
      reason: "立ちっぱなしや座りっぱなしで、脚の外側が張る日に行います。",
      care_kind: "stroke",
    },
    {
      id: "line-liver-gb-side-bend",
      line_id: "line-liver-gb",
      title: "上体を左右へ小さく倒す",
      action: "椅子に座って両手を太ももへ置き、息を吐きながら上体を右へ少し倒して戻します。左も同様に、左右3回ずつ行います。",
      reason: "脇腹から腰の横にかけて縮こまる感じがある日に向く動きです。",
      care_kind: "movement",
    },
  ],
  spleen_st: [
    {
      id: "line-spleen-st-abdominal-breath",
      line_id: "line-spleen-st",
      title: "お腹に手を置いて6呼吸",
      action: "仰向けになって膝を立て、おへその上へ片手を置きます。手がゆっくり上下するのを感じながら、吐く息を少し長くして6呼吸します。",
      reason: "お腹に力が入り続けている時に、まず呼吸だけへ絞って行うケアです。",
      care_kind: "breath",
    },
    {
      id: "line-spleen-st-shin-stroke",
      line_id: "line-spleen-st",
      title: "すねの外側を5回なでる",
      action: "椅子に座り、膝の少し下から足首へ向かって、すねの外側を手のひらで5回なでます。左右を順番に行います。",
      reason: "胃腸の疲れなどで、脚の前面が重く感じる日に行います。",
      care_kind: "stroke",
    },
    {
      id: "line-spleen-st-knee-extension",
      line_id: "line-spleen-st",
      title: "座って膝を伸ばす",
      action: "椅子へ深く座り、片脚の膝をゆっくり伸ばして戻します。反動をつけず、左右5回ずつ行います。",
      reason: "座ったまま脚の前面を軽く動かし、動き始めを作るケアです。",
      care_kind: "movement",
    },
  ],
  pc_sj: [
    {
      id: "line-pc-sj-outer-forearm-stroke",
      line_id: "line-pc-sj",
      title: "前腕の外側をなでる",
      action: "手の甲を上へ向け、反対の手で手首から肘へ向かってゆっくり3回なでます。左右を順番に行います。",
      reason: "上半身の熱や力みが腕へ残る時に、軽い刺激で行うケアです。",
      care_kind: "stroke",
    },
    {
      id: "line-pc-sj-inner-forearm-stroke",
      line_id: "line-pc-sj",
      title: "前腕の内側をなでる",
      action: "手のひらを上へ向け、反対の手で肘の内側から手首の中央へゆっくり3回なでます。左右を順番に行います。",
      reason: "緊張して手や腕まで力が抜けにくい日に行います。",
      care_kind: "stroke",
    },
    {
      id: "line-pc-sj-wrist-circle",
      line_id: "line-pc-sj",
      title: "手首を小さく回す",
      action: "肘を体の横へつけ、手首を外回し・内回しに各3回ずつ回します。反対側も同様に行います。",
      reason: "手作業や画面操作が続き、前腕に力が残っている時の一手です。",
      care_kind: "movement",
    },
  ],
};

const MERIDIAN_CARE_KIND_ORDER = {
  cold: ["hand_contact", "movement", "breath", "stroke"],
  heat: ["breath", "movement", "stroke", "hand_contact"],
  damp: ["movement", "stroke", "breath", "hand_contact"],
  pressure_down: ["movement", "stroke", "breath", "hand_contact"],
  dry: ["breath", "movement", "hand_contact", "stroke"],
  pressure_up: ["breath", "movement", "stroke", "hand_contact"],
  temp_shift: ["movement", "breath", "stroke", "hand_contact"],
  default: ["breath", "stroke", "movement", "hand_contact"],
};
...
function shiftYmdDate(targetDate, days) {
  const match = String(targetDate || "").match(/^(\d{4})-(\d{2})-(\d{2})$/);
  if (!match) return targetDate || null;
...
function getContinuousConstitution(riskContext) {
  ...
  const split = constitution?.split_scores && typeof constitution.split_scores === "object"
    ...
    : null;
  const directMaterial = constitution?.material_scores && typeof constitution.material_scores === "object"
    ? constitution.material_scores
    : null;
  const scoreScale = constitution?.score_scale || split?.scale || null;
  const material = {
    qi_deficiency: Number(directMaterial?.qi_deficiency ?? split?.qi?.deficiency ?? 0),
    qi_stagnation: Number(directMaterial?.qi_stagnation ?? split?.qi?.stagnation ?? 0),
    blood_deficiency: Number(directMaterial?.blood_deficiency ?? split?.blood?.deficiency ?? 0),
    blood_stasis: Number(directMaterial?.blood_stasis ?? split?.blood?.stasis ?? 0),
    fluid_deficiency: Number(directMaterial?.fluid_deficiency ?? split?.fluid?.deficiency ?? 0),
    fluid_damp: Number(directMaterial?.fluid_damp ?? split?.fluid?.damp ?? 0),
  };
  return {
    available: Boolean(axes || split),
    yin_yang_score: Math.max(-1, Math.min(1, Number(axes?.reaction_score ?? axes?.yin_yang_score ?? 0))),
    drive_score: Math.max(-1, Math.min(1, Number(axes?.reserve_score ?? axes?.drive_score ?? 0))),
...
function addContinuousConstitutionScores(scores, continuous) {
  ...
  Object.entries(continuous.material || {}).forEach(([key, raw]) => {
    ...
    const normalized = continuous.score_scale === "0_100"
...
// 選ばれた方針へ実際に加点した要因だけを短く説明する。
export function buildCarePolicyReason({ policies, primary, secondary, subLabels, symptomFocus, continuous, reactionDirection, reserveSmall, mode }) {
  const keys = policies.map((p) => p.key);
  const weight = (values) => keys.reduce((sum, key) => sum + Number(values?.[key] || 0), 0);
  const materialLabels = {
    qi_deficiency: "疲れやすさ", qi_stagnation: "力みやすさ", blood_deficiency: "消耗しやすさ",
    blood_stasis: "こわばりやすさ", fluid_damp: "重だるさの出やすさ", dampness: "重だるさの出やすさ", fluid_deficiency: "乾きやすさ",
  };
  const reasons = subLabels.map((key, index) => ({
    text: `体質チェックでみられた${materialLabels[key] || "身体の傾向"}`,
    score: weight(SUB_LABEL_POLICY_SCORES[key]) * (index === 0 ? 1 : 0.58),
  }));
  Object.entries(continuous.material || {}).forEach(([key, raw]) => {
    const value = Math.max(0, Number(raw || 0));
    const normalized = continuous.score_scale === "0_100" ? Math.min(1, value / 100) : value / (value + 2.5);
    reasons.push({text: `体質チェックでみられた${materialLabels[key]}`, score: weight(MATERIAL_POLICY_SCORES[key]) * normalized});
  });
  if (symptomFocus) reasons.push({text: `気になる${SYMPTOM_CONTEXT_LABELS[symptomFocus] || "不調"}`, score: weight(SYMPTOM_POLICY_SCORES[symptomFocus])});
  if (reserveSmall && keys.includes("sasaeru")) reasons.push({text:"体質チェックでみられた余力の少なさ", score:1.35 * Math.max(0, -Number(continuous.drive_score || 0)) + (!continuous.available ? 1.2 : 0)});
  const reactionText = reactionDirection === "accel" ? "体質チェックでみられた力みやすい傾向" : "体質チェックでみられた重だるさが出やすい傾向";
  reasons.push({text:reactionText, score:weight(REACTION_POLICY_SCORES[reactionDirection])});
  const reason = reasons.filter((r) => r.score > 0).sort((a,b) => b.score-a.score)[0]?.text;
  const weather = [primary, secondary].filter((key,index,all) => key && !["none","default"].includes(key) && all.indexOf(key) === index && weight(TRIGGER_POLICY_SCORES[key]) > 0)
    .map((key) => key.startsWith("pressure_") ? "気圧変化" : TRIGGER_LABELS[key]).filter(Boolean);
  const weatherText = weather.length ? `${mode === "tomorrow" ? "明日" : "今日"}の${[...new Set(weather)].join("・")}` : "";
  const basis = [weatherText, reason].filter(Boolean).join("と");
  return `${basis ? `${basis}を踏まえ、` : "普段の体調を整えるため、"}${policies.map((p) => p.short).join("・")}方針です。`;
}
...
export function buildDailyCareTheme({
  ...
  return {
    ...
    selection_reason: buildCarePolicyReason({ policies, primary, secondary, subLabels: getSubLabels(riskContext, subLabels), symptomFocus, continuous, reactionDirection, reserveSmall, mode }),
...
function activeConstitutionSignals(theme) {
  ...
  Object.entries(profile?.material || {}).forEach(([key, raw]) => {
    const value = Math.max(0, Number(raw || 0));
    const normalized = profile?.score_scale === "0_100"
      ? Math.min(1, value / 100)
      : value / (value + 2.5);
    if (value > 0) signals[key] = Math.max(Number(signals[key] || 0), normalized);
  });
...
function lifestyleCandidateScore(candidate, { theme, symptomFocus }) {
  ...
  if (candidate?.conditional && symptomFocus && !safeArray(candidate.symptoms).includes(symptomFocus)) return null;
  if (theme?.mode === "tomorrow" && !safeArray(candidate?.modes).includes("tomorrow")) return null;
...
// Only completed action rows from earlier target dates affect continuity.
// No view history, effectiveness, or non-execution is inferred from a missing row.
const PERSISTENT_SETUP_IDS = new Set([
  "tool-arm-support", "tool-screen-height", "tool-work-height", "tool-foot-support",
  "tool-light-zone", "tool-back-support", "tool-leg-rest", "tool-side-sleep-support",
  "tool-facing-layout", "tool-sound-zone", "tool-carry-distribution",
]);

export function recentCompletedCare(actions, targetDate, days = 7) {
  const target = foodDateOrdinal(targetDate);
  if (!/^\d{4}-\d{2}-\d{2}$/.test(String(targetDate || ""))) return [];
  return safeArray(actions).filter((row) => {
    if (!row?.checked_at || !/^\d{4}-\d{2}-\d{2}$/.test(String(row.target_date || ""))) return false;
    const age = target - foodDateOrdinal(row.target_date);
    return age > 0 && age <= days;
  });
}

function completedRuleIds(theme, days = 7) {
  return new Set(recentCompletedCare(theme?.completed_care, theme?.target_date, days)
    .filter((row) => row.domain === "live" && row.kind === "lifestyle_step")
    .map((row) => row.item_snapshot?.meta?.rule_id).filter(Boolean));
}

function preferUnrepeatedLifestyle(items, theme) {
  if (!items.length) return items;
  const done = completedRuleIds(theme);
  const recent = completedRuleIds(theme, 2);
  const best = Math.max(...items.map((item) => item._score));
  const eligible = items.filter((item) => item._score >= best - LIFESTYLE_CANDIDATE_NEAR_TIE_DELTA);
  const fresh = eligible.filter((item) => !(PERSISTENT_SETUP_IDS.has(item.id) ? done : recent).has(item.id));
  return fresh.length ? fresh : items;
}

function lifestyleDisplayCopy(item, theme) {
  const setupDone = PERSISTENT_SETUP_IDS.has(item.id) && completedRuleIds(theme).has(item.id);
  return {
    short_action: item.text,
    continuity_note: theme?.avoid_lifestyle_ids?.includes(item.id)
      ? "今日と共通のケアです。今夜の場面にも合う時に取り入れてください。"
      : setupDone
      ? "この調整は、この1週間に実行した記録があります。今の配置で楽に過ごせていれば、そのまま使いましょう。"
      : "",
  };
}
...
function selectLifestyleCareCandidates({
  ...
  const scored = unique
    .map((item) => {
      const candidate = {
        ...item,
        ...(LIFESTYLE_USAGE[item.id] || {}),
        ...(item?.symptom_copy?.[symptomFocus] || {}),
      };
      if (!candidate.scenes?.includes(theme?.lifestyle_scene || "general")) return null;
  ...
  const relevantPool = symptomFocus ? symptomPool : scored;
  const common = relevantPool.filter((item) => !item.restricted);
  const avoid = new Set(theme?.avoid_lifestyle_ids || []);
  function choose(pool, slot) {
    if (!pool.length) return null;
    const best = Math.max(...pool.map((x) => x._score));
    const peers = pool.filter((x) => x._score >= best - LIFESTYLE_CANDIDATE_NEAR_TIE_DELTA);
    const fresh = peers.filter((x) => !avoid.has(x.id));
    return rotateNearTies(preferUnrepeatedLifestyle(fresh.length ? fresh : peers, theme), {
      targetDate, contextKey: `${contextKey}|${slot}`,
    })[0] || null;
  }
  const withoutTool = choose(common.filter((x) => !x.equipment), "without-tool");
  const withTool = choose(common.filter((x) => x.equipment), "with-tool");
  const selected = [withoutTool, withTool].filter(Boolean);
  const conditional = choose(relevantPool.filter((x) => x.restricted), "conditional");
  const primary = selected[0];
  return {
    selected, conditional,
    primaryKind: primary?.care_kind || "none",
    primaryCandidateScore: primary?._score || 0,
    laneScores: { body: bestLaneScore(scored, "body"), environment: bestLaneScore(scored, "environment") },
    nearTieRotationApplied: false,
    shopCandidate: selected.find((item) => item.equipment && item.shop_eligible && item.item_role) || null,
  };
}
...
function buildLifestyleForecastInsight({ theme, symptomFocus } = {}) {
  if (theme?.trigger_key === "none") return "目立った気象負担はありません。普段気になる不調に合わせ、無理なく続けられるケアを選びましょう。";
...
export function enhanceLifestylePlan({
  ...
  const selected = [...selection.selected, ...(selection.conditional ? [selection.conditional] : [])];
  ...
  if (!primary) {
    ...
    return {
      ...
      no_suggestion_text: noSuggestionToday
        ? "この場面と不調に合う候補はありません。場面を変えるか、食べる・ほぐすを見てみてください。"
        : "今夜のこの場面に合う候補はありません。場面を変えるか、食べる・ほぐすを見てみてください。",
      selection_basis: {
        primary_kind: "none",
  ...
  const enhanced = {
    ...
    primary_action: {
      id: primary.id,
      ...lifestyleDisplayCopy(primary, theme),
      label: primary.text,
      care_kind: primary.care_kind || "body",
      kind_label: primary.equipment ? "道具を使う一手" : "道具なしの一手",
      equipment: primary.equipment || null,
      restricted: Boolean(primary.restricted),
      scene: primary.scene || "",
    ...
    alternatives: alternatives.map((item) => ({
      id: item.id,
      ...lifestyleDisplayCopy(item, theme),
      label: item.text,
      care_kind: item.care_kind || "body",
      kind_label: item.equipment ? "道具を使う一手" : "道具なしの一手",
...
function buildMealItemDetail(idea, { label = null, reasonContext = {} } = {}) {
  return {
    ...
    preparation: idea?.effort === "low" ? idea?.note || "" : "",
    reasons: buildMealReasons(idea, reasonContext),
    record_label: buildMealFocusIngredients(idea).length
      ? `${buildMealFocusIngredients(idea).join("・")}などを食事に取り入れる`
      : `${idea?.label || "提案の食事"}の食べ方を取り入れる`,
    record_semantics: "ingredients_or_eating_pattern",
  };
}

function buildFoodForecastInsight({ theme, symptomFocus, primaryPolicy }) {
  if (theme?.trigger_key === "none") return `目立った気象負担はありません。食事では、${POLICY_FOOD_ACTIONS[primaryPolicy] || POLICY_FOOD_ACTIONS.sasaeru}`;
  const timing = theme?.mode === "tomorrow" ? "明日は" : "今日は";
  const weather = safeArray(theme?.trigger_labels).filter(Boolean).join("と") || "天気変化";
  const reaction = theme?.reaction_direction === "accel"
    ? "アクセル寄りの反応"
...
function isEverydayFoodCandidate(idea) {
  return !SPECIALTY_CUISINES.has(String(idea?.cuisine || ""))
    && !/鴨|レンズ豆|キヌア|ピタサンド|ディル|ライ麦|タブレ/.test(String(idea?.label || ""));
}
...
function selectFoodIdeas({ catalog, catalogKey, theme, targetDate, symptomFocus, subLabels, limit = 3 }) {
  ...
  const completed = recentCompletedCare(theme?.completed_care, targetDate, 3)
    .filter((row) => row.domain === "eat");
  const labels = new Set(completed.flatMap((row) => [row.label, row.item_snapshot?.meta?.meal_example, ...(row.item_snapshot?.meta?.items || [])]));
  const recentMeals = safeArray(catalog).filter((idea) => labels.has(idea.label));
  const unused = preferred.filter((idea) => !labels.has(idea.label));
  const pool = unused.length ? unused : preferred;
  const easy = pool.filter((idea) => idea.effort === "low" || safeArray(idea.tags).includes("quick"));
  const firstPool = easy.length >= 3 ? easy : pool;
  const varied = firstPool.filter((idea) => !recentMeals.some((old) => old.protein === idea.protein && old.format === idea.format));
  const ordered = [...rotate(varied.length ? varied : firstPool), ...rotate(pool), ...rotate(rest, 5)];
  return diversifyFoodCandidates(ordered, limit);
}
...
export function enhanceFoodContext({baseFood=null,theme={},targetDate=null,symptomFocus=null,subLabels=[],mode="today"}={}) {
  const food=baseFood||{};
  const normalizedMode=mode==="tomorrow"?"tomorrow":"today";
  // Rebuild against the selected date and current symptom, including saved forecasts.
  const drinkCard=buildDrinkActionCard({mode:normalizedMode,targetDate,
    triggerKey:theme.trigger_key||'default',secondaryKey:theme.secondary_trigger_key||null,
    symptomFocus:symptomFocus||theme.symptom_focus||null,
    subLabels:[...safeArray(theme.sub_labels),...safeArray(subLabels)],reactionDirection:theme.reaction_direction||null});
  const plan=buildTcmFoodPlan({theme,targetDate,symptomFocus,subLabels,mode:normalizedMode,drinkCard});
  const commerce=buildFoodCommerceContext({theme,symptomFocus,subLabels});
  // Shop intent is food-therapy products/tea, not grocery procurement.
  commerce.version="food_commerce_context_v2_tcm";
  commerce.basis="constitution_and_daily_care_policy";
  commerce.nutrition_need_keys=[];
  commerce.nutrition_needs=[];
  commerce.summary=commerce.tcm_functions.slice(0,2).map(f=>f.public_label).join("・");
  commerce.product_role_keys=["daily_tea","food_therapy"];
  commerce.product_roles=[{key:"daily_tea",label:"薬膳茶・食養生のお茶"},{key:"food_therapy",label:"食養生系の健康食品"}];
  return {...food,...plan,care_theme:theme,commerce_context:commerce,
    drink_model_version:"v7.79.71-drink-personality",drink_count:14,
    symptom_focus:symptomFocus||theme.symptom_focus||null,trigger_key:theme.trigger_key||"default",secondary_trigger_key:theme.secondary_trigger_key||null,
    badge:normalizedMode==="tomorrow"?"今夜から明日に備える":"今日の食養生",
    recommendation:null,food_care_profile:buildFoodCareProfile({theme,symptomFocus,subLabels}),
    context_chips:buildFoodCareProfile({theme,symptomFocus,subLabels}).context_chips};
}

function buildMeridianGuidanceNote(theme, selected) {
  const prefix = theme?.mode === "tomorrow" ? "今夜は" : "今日は";
  const intensity = theme?.stimulus === "弱め・短め"
    ? "弱め・短めで十分です。"
    : theme?.stimulus === "軽く一度"
      ? "軽く1セットで十分です。"
      : "やさしく短く行います。";
  const trigger = normalizeDailyCareTrigger(theme?.trigger_key);
  if (trigger === "cold") return `${prefix}急がず、${intensity}`;
  if (trigger === "heat") return `${prefix}汗ばむほど続けず、${intensity}`;
  if (["damp", "pressure_down"].includes(trigger)) return `${prefix}重だるさが増えない範囲で、${intensity}`;
  if (trigger === "dry" && ["stroke", "hand_contact"].includes(selected?.care_kind)) {
    return `${prefix}肌を強くこすらず、服の上から行って構いません。${intensity}`;
  }
  if (trigger === "dry") return `${prefix}乾燥で刺激を増やさないよう、${intensity}`;
  if (["pressure_up", "temp_shift"].includes(trigger)) return `${prefix}息を止めない速さで、${intensity}`;
  return `${prefix}${intensity}`;
}

function selectMeridianLineCare({ meridianCode, theme, options: eligibleOptions = null } = {}) {
  const options = eligibleOptions || safeArray(MERIDIAN_LINE_CARE[meridianCode]);
  if (!options.length) return null;
  const trigger = normalizeDailyCareTrigger(theme?.trigger_key);
  const order = MERIDIAN_CARE_KIND_ORDER[trigger] || MERIDIAN_CARE_KIND_ORDER.default;
  const ranked = [...options].sort((a, b) => {
    const aRank = order.indexOf(a.care_kind);
    const bRank = order.indexOf(b.care_kind);
    const normalizedA = aRank === -1 ? order.length : aRank;
    const normalizedB = bRank === -1 ? order.length : bRank;
    return normalizedA - normalizedB || a.id.localeCompare(b.id);
  });
  const contextKey = `meridian-line|${meridianCode}|${trigger}`;
  const rotationIndex = getDailyCareRotationIndex({
    targetDate: theme?.target_date,
    contextKey,
    length: ranked.length,
  });
  if (theme?.mode === "tomorrow" && ranked.length > 1) {
    const previousDate = shiftYmdDate(theme?.target_date, -1);
    const previousIndex = getDailyCareRotationIndex({
      targetDate: previousDate,
      contextKey,
      length: ranked.length,
    });
    const previousTodayId = ranked[previousIndex]?.id;
    const tomorrowOptions = ranked.filter((item) => item.id !== previousTodayId);
    const tomorrowIndex = getDailyCareRotationIndex({
      targetDate: theme?.target_date,
      contextKey: `${contextKey}|tomorrow`,
      length: tomorrowOptions.length,
    });
    return tomorrowOptions[tomorrowIndex] || ranked[(rotationIndex + 1) % ranked.length];
  }
  return ranked[rotationIndex] || ranked[0];
}

// Selection heuristics reuse the existing point/constitution care directions.
// These weights rank care candidates; they are not measurements of line burden.
export const DAILY_LINE_PROFILES = {
  lung_li: { label: "胸・腕のライン", symptoms: ["neck_shoulder", "headache"], triggers: ["dry"], sub: ["fluid_deficiency"], policies: ["uruosu", "yurumeru"] },
  heart_si: { label: "肩・腕のライン", symptoms: ["neck_shoulder", "sleep"], triggers: [], sub: [], policies: ["shizumeru", "yurumeru"] },
  kidney_bl: { label: "腰・脚の後ろのライン", symptoms: ["low_back_pain", "fatigue", "swelling", "dizziness"], triggers: ["cold", "pressure_down"], sub: ["qi_deficiency", "blood_deficiency"], policies: ["nukumeru", "sasaeru"] },
  liver_gb: { label: "脇腹・脚の外側のライン", symptoms: ["mood", "headache", "neck_shoulder", "low_back_pain"], triggers: ["pressure_up", "heat"], sub: ["qi_stagnation", "blood_stasis"], policies: ["meguraseru", "yurumeru"] },
  spleen_st: { label: "お腹・脚の前のライン", symptoms: ["digestion", "swelling", "fatigue"], triggers: ["damp", "pressure_down"], sub: ["fluid_damp", "qi_deficiency"], policies: ["nagasu", "sasaeru"] },
  pc_sj: { label: "腕・手首のライン", symptoms: ["mood", "sleep", "neck_shoulder", "dizziness", "digestion"], triggers: ["heat", "pressure_up"], sub: ["qi_stagnation"], policies: ["shizumeru", "yurumeru"] },
};

// Keep motions relevant to the selected concern even when the line has several options.
const DAILY_LINE_ACTION_SYMPTOMS = {
  "line-lung-li-clavicle-stroke": ["neck_shoulder", "headache", "sleep", "mood"],
  "line-lung-li-chest-breath": ["neck_shoulder", "headache", "sleep", "mood", "fatigue"],
  "line-lung-li-thumb-forearm-stroke": ["neck_shoulder"],
  "line-heart-si-little-finger-stroke": ["neck_shoulder"],
  "line-heart-si-scapula-contact": ["neck_shoulder"],
  "line-heart-si-shoulder-roll": ["neck_shoulder", "sleep", "mood"],
  "line-kidney-bl-low-back-contact": ["low_back_pain", "fatigue"],
  "line-kidney-bl-calf-stroke": ["swelling", "fatigue", "dizziness"],
  "line-kidney-bl-toe-lift": ["swelling", "fatigue", "dizziness"],
  "line-liver-gb-side-breath": ["mood", "headache", "neck_shoulder", "sleep"],
  "line-liver-gb-outer-thigh-stroke": ["low_back_pain", "fatigue"],
  "line-liver-gb-side-bend": ["low_back_pain", "neck_shoulder"],
  "line-spleen-st-abdominal-breath": ["digestion", "sleep", "mood", "fatigue"],
  "line-spleen-st-shin-stroke": ["digestion", "swelling", "fatigue"],
  "line-spleen-st-knee-extension": ["swelling", "fatigue"],
  "line-pc-sj-outer-forearm-stroke": ["neck_shoulder", "mood", "sleep"],
  "line-pc-sj-inner-forearm-stroke": ["mood", "sleep", "digestion", "dizziness", "neck_shoulder"],
  "line-pc-sj-wrist-circle": ["neck_shoulder", "mood"],
};

function lineHistory(theme) {
  return recentCompletedCare(theme?.completed_care, theme?.target_date, 3)
    .filter(row => row.kind === "tsubo_line_care" && row.domain === "loosen");
}

export function rankDailyMeridianLines({ theme = {}, riskContext = null } = {}) {
  const primary = theme.primary_meridian || riskContext?.constitution_context?.primary_meridian;
  const secondary = theme.secondary_meridian || riskContext?.constitution_context?.secondary_meridian;
  const symptom = theme.symptom_focus || riskContext?.constitution_context?.symptom_focus;
  const trigger = normalizeDailyCareTrigger(theme.trigger_key);
  const secondTrigger = normalizeDailyCareTrigger(theme.secondary_trigger_key);
  const sub = new Set(getSubLabels(riskContext, theme.sub_labels).map(value => ({ 気虚: "qi_deficiency", 気滞: "qi_stagnation", 血虚: "blood_deficiency", 瘀血: "blood_stasis", 津液不足: "fluid_deficiency", 水滞: "fluid_damp", 痰湿: "fluid_damp", dampness: "fluid_damp" }[value] || value)));
  const policies = safeArray(theme.policies).map(p => p.key);
  const rows = Object.entries(DAILY_LINE_PROFILES).map(([code, profile]) => {
    const checked = code === primary ? 3 : code === secondary ? 2 : 0;
    const symptomMatch = profile.symptoms.includes(symptom);
    const weather = profile.triggers.includes(trigger) ? 3 : secondTrigger !== trigger && profile.triggers.includes(secondTrigger) ? 1 : 0;
    const constitution = Math.min(2, profile.sub.filter(x => sub.has(x)).length);
    const policy = Math.min(1, profile.policies.filter(x => policies.includes(x)).length);
    const options = MERIDIAN_LINE_CARE[code].filter(item => !symptom || (DAILY_LINE_ACTION_SYMPTOMS[item.id] || []).includes(symptom));
    const score = checked + (symptomMatch ? 6 : 0) + weather + constitution + policy;
    return { code, label: profile.label, score, checked, symptom: symptomMatch ? symptom : null, weather: weather ? (profile.triggers.includes(trigger) ? trigger : secondTrigger) : null, constitution, policy, options };
  }).filter(row => row.options.length && (row.checked || row.symptom || row.weather || row.constitution))
    .sort((a,b) => b.score - a.score || a.code.localeCompare(b.code));
  // When a current concern is known, retain its matches and eligible checked lines.
  return rows.some(row => row.symptom) ? rows.filter(row => row.symptom || row.checked) : rows;
}

export function buildMeridianLineCare({ theme = {}, riskContext = null } = {}) {
  const ranked = rankDailyMeridianLines({ theme, riskContext });
  if (!ranked.length) return null;
  // Rotate only candidates close to the best fit. History never promotes a weak match.
  let pool = ranked.filter(row => row.score >= ranked[0].score - 2);
  const history = lineHistory(theme);
  const used = new Set(history.map(row => row.item_snapshot?.meta?.meridian_code));
  const fresh = pool.filter(row => !used.has(row.code));
  if (fresh.length) pool = fresh;
  const index = getDailyCareRotationIndex({ targetDate: theme.target_date, contextKey: `daily-line|${theme.symptom_focus || "general"}|${theme.trigger_key || "none"}`, length: pool.length });
  const chosen = pool[index] || pool[0];
  let options = chosen.options;
  const usedIds = new Set(history.map(row => row.item_snapshot?.meta?.rule_id));
  const unused = options.filter(item => !usedIds.has(item.id));
  if (unused.length) options = unused;
  const selected = selectMeridianLineCare({ meridianCode: chosen.code, theme, options });
  const source = chosen.checked ? (chosen.symptom || chosen.weather || chosen.constitution ? "combined" : "check") : "daily";
  const clues = [];
  if (chosen.checked) clues.push("体質チェックで選んだ負担ライン");
  if (chosen.symptom) clues.push(SYMPTOM_CONTEXT_LABELS[chosen.symptom] || chosen.symptom);
  if (chosen.weather) clues.push(`${TRIGGER_LABELS[chosen.weather]}への備え`);
  if (chosen.constitution) clues.push("体質の傾向");
  const selectionReason = `${clues.slice(0, 2).join("と")}をもとに、${chosen.label}のケアを選びました。`;
  return {
    ...selected, meridian_code: chosen.code, line_label: chosen.label,
    selection_source: source, selection_reason: selectionReason,
    selection_basis: { checked_rank: chosen.checked === 3 ? 1 : chosen.checked === 2 ? 2 : null, symptom: chosen.symptom, weather: chosen.weather, constitution: Boolean(chosen.constitution), rule_version: "daily_line_v1" },
    intensity: theme.stimulus || "やさしく短く",
    guidance_note: buildMeridianGuidanceNote(theme, selected),
    timing_label: theme.mode === "tomorrow" ? "今夜〜明朝の一手" : "今日の一手",
    target_date: theme.target_date || null, label: selected.action,
  };
}
...
export function enhanceTsuboSet({ baseTsuboSet = null, theme, riskContext = null } = {}) {
  ...
  return {
    ...
    lead: lineCare
      ? [lineCare.selection_reason, lineCare.reason, lineCare.guidance_note].filter(Boolean).join(" ")
      : set.lead || "短く触れて、体の反応を見てみましょう。",
    line_care: lineCare,
    continuity_note: primaryPoint && recentCompletedCare(theme?.completed_care, theme?.target_date)
      .some((row) => row.domain === "loosen" && row.item_snapshot?.meta?.point_code === primaryPoint.code)
      ? `${primaryPoint.name_ja || primaryPoint.code}はこの1週間にもケアした記録があります。今回も体質と今の状態に合わせた候補です。触れる前後の感じを比べてみましょう。`
      : "",
...
export function enhanceDailyCarePlan({
  ...
  Object.defineProperty(theme, "completed_care", { value: recentCompletedCare(completedCare, target), enumerable: false });
  theme.lifestyle_scene = LIFESTYLE_SCENES.some((x) => x.key === lifestyleScene) ? lifestyleScene : "general";
  theme.avoid_lifestyle_ids = safeArray(avoidLifestyleIds);
