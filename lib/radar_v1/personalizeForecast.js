...
function buildTriggerFactors({ effectiveLoads, weatherStrengths, affinityWeights }) {
...
function buildTriggerFactor({ key, role, effectiveLoads, weatherStrengths, affinityWeights }) {
