...
function computeBaseWeatherScore(personalChannels) {
  return clamp(
    personalChannels.pressure_down * 2.2 +
      personalChannels.pressure_up * 1.3 +
      personalChannels.cold * 1.8 +
      personalChannels.heat * 1.3 +
      personalChannels.damp * 1.8 +
      personalChannels.dry * 1.2,
    0,
    10
  );
}
