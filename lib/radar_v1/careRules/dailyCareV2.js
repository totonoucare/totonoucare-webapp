...
export const DAILY_CARE_LOGIC_VERSION = "daily_care_v2_9_2026-07-31_environment_body_lifestyle_care";
...
// 環境ケアは、予報から分かる暑さ・寒さ・湿気・乾燥へ直接触れられるものだけ。
// 予定、休憩、止め時などの行動療法は暮らすケアへ混ぜない。
// 気圧は室内環境で変えられないため、気圧だけに反応する環境候補も作らない。
const ENVIRONMENT_EXPERIMENT_CANDIDATES = [
  {
    ...
    scene_label: "湿気の逃がし方",
    scene: "湿気が強い日に、窓を開けても空気が軽くならない時",
    headline: "窓を閉め、冷房の除湿へ切り替える",
    text: "窓を閉め、使えるなら冷房の除湿へ切り替える。浴室や調理の湿気は換気扇で外へ出す",
    reason: "外から入る湿気を増やさず、家の中で出た湿気を外へ逃がせます。",
    felt_sense: "10分後、肌や床のべたつきが増えない方を今日のやり方に。",
    reset: "暑さが残るなら、除湿より冷房を優先しよう。",
    triggers: ["damp"],
  ...
  },
  {
    ...
    scene_label: "窓からの熱",
    scene: "冷房を入れても、窓の近くほど暑く感じる時",
    headline: "日が当たる窓だけ、カーテンを閉める",
    text: "日が当たる窓だけ、カーテンかブラインドを閉めて10分比べる",
    reason: "窓から入る熱を一つ減らせます。",
    felt_sense: "窓側に立った時、顔や腕の熱さが弱ければそのままでOK。",
    reset: "暗くなりすぎるなら、日が当たる側だけ閉めよう。",
    triggers: ["heat"],
  ...
  },
  {
    ...
    scene_label: "暑さと湿気",
    scene: "暑さと湿気が重なり、送風だけではべたつきが残る時",
    headline: "冷房か除湿へ切り替える",
    text: "送風を止め、冷房か除湿へ切り替えて10分比べる",
    reason: "汗が乾きにくい空気そのものを変えられます。",
    felt_sense: "肌のべたつきや息苦しさが少ない方を使おう。",
    reset: "冷えすぎるなら、設定温度を一度上げよう。",
    triggers: ["heat", "damp"],
  ...
  },
  {
    ...
    scene_label: "乾いた風",
    scene: "暖房や送風が、顔や首へまっすぐ当たる時",
    headline: "椅子を半歩ずらすか、風を壁へ向ける",
    text: "室温はそのまま。椅子を半歩ずらすか、風向きを壁側へ向けて10分比べる",
    reason: "目・鼻・のどへ当たり続ける乾いた風を減らせます。",
    felt_sense: "まばたきや喉の乾きが増えない位置を使おう。",
    reset: "暑く感じるなら、風量を戻して向きだけ変えよう。",
    triggers: ["dry"],
  ...
  },
  {
    ...
    scene_label: "冷たい風",
    scene: "冷房や外気が、首や肩へまっすぐ当たる時",
    headline: "椅子を半歩ずらすか、風を壁へ向ける",
    text: "設定温度はそのまま。椅子を半歩ずらすか、風向きを壁側へ変える",
    reason: "同じ所へ冷たい風が当たり続ける条件を外せます。",
    felt_sense: "肩を下げようとしなくても、首元が固まりにくい位置を使おう。",
    reset: "暑くなるなら、元の場所から首元だけ風の線を外そう。",
    triggers: ["cold"],
  ...
  },
  {
    ...
    scene_label: "足元の冷え",
    scene: "座っていても、足元から腰や肩まで力が入る時",
    headline: "足元へ、薄いマットか畳んだタオルを一枚",
    text: "足元へ、薄いマットか畳んだタオルを一枚置く。床へ直接置く時と3分ずつ比べる",
    reason: "部屋を暖めすぎず、床から足裏へ続く冷たさを減らせます。",
    felt_sense: "足指の踏ん張りが少ない方を使おう。",
    reset: "蒸れたり足元が不安定なら、すぐ外してOK。",
    triggers: ["cold"],
...
const PUBLIC_ACTION_COPY_BY_ID = {
  "tension-open-palm-carry": {
    ...
    scene: "コップやボトルを持つ手が、だんだん固くなる時",
    symptoms: ["neck_shoulder", "fatigue"],
    headline: "指の力を一段ゆるめる",
    text: "手のひらと物の間に、少し隙間が残るくらいで持ってみる。滑らない範囲で、指の力を一段ゆるめる",
  ...
  "tension-little-finger-thumb-line": {
    scene_family: "hold_carry",
    scene: "買い物袋の細い取っ手が、指に食い込む時",
    symptoms: ["neck_shoulder", "fatigue"],
    headline: "取っ手を指の付け根側へ掛ける",
    text: "取っ手を指の付け根まで入れて、親指は上から軽く添える",
  ...
  "tension-phone-thumb-line": {
    ...
    scene: "スマホを持つ手や親指が疲れてきた時",
    symptoms: ["neck_shoulder", "headache"],
    headline: "スマホの下側を両手で支える",
    text: "スマホの下側を両手で支える。画面の端は、届く方の手へ持ち替えて押す",
    reason: "片方の親指を伸ばしっぱなしにせずに済みます。",
    felt_sense: "親指の付け根と肩がラクならOK。",
    reset: "手が疲れるなら、いったん机へ置いて操作しよう。",
  },
  "tension-screen-head-up": {
    scene_family: "screen_handwork",
    scene: "画面から顔を上げた時、首の後ろが詰まるなら",
    symptoms: ["neck_shoulder", "headache"],
  ...
  "tension-wall-axis": {
    scene_family: "screen_handwork",
    scene: "キーボードやマウスを使う肩が重い時",
    symptoms: ["neck_shoulder", "headache", "fatigue"],
    headline: "前腕のひじ寄りを、机へそっと載せる",
    text: "椅子を机へ近づけ、前腕のひじ寄りを机へそっと載せる",
  ...
  "tension-inner-ankle-stand": {
    ...
    scene: "立っていると、足指が床をつかむように固くなる時",
    symptoms: ["low_back_pain", "fatigue", "swelling"],
    headline: "足指を一度浮かせてから、床へ戻す",
    text: "足指を一度浮かせ、かかとと足の付け根へ重さを置く。そのまま指を床へ戻す",
    reason: "足先の踏ん張りが抜けると、腰まで力が上がりにくくなります。",
    felt_sense: "戻した足指が、自由に動けばOK。",
    reset: "ふらつくなら、壁や台へ手を添えてやろう。",
  },
  "tension-supported-one-leg": {
    scene_family: "hold_posture",
    scene: "待ち時間や立ち仕事で、片方の腰へ寄りかかる時",
    symptoms: ["low_back_pain", "fatigue", "swelling"],
  ...
  "tension-walk-center-first": {
    ...
    scene: "歩き始めの足取りが重い時は",
    symptoms: ["fatigue", "swelling", "low_back_pain"],
    headline: "最初の5歩だけ、歩幅を少し小さくする",
    text: "最初の5歩だけ、歩幅を少し小さくする。体の真下へ来た足に、そっと体重を移す",
    reason: "後ろ足で強く蹴らなくても、歩き出しやすくなります。",
    felt_sense: "靴音が少し小さくなったらOK。",
    reset: "前へ倒れそうなら、いつもの歩幅へ戻そう。",
  },
  "tension-seated-foot-head": {
    scene_family: "hold_posture",
    scene: "座っていると、片方のお尻だけ重くなる時",
  ...
  "tension-sit-stand-innerline": {
    ...
    scene: "椅子から立つ時、腰へ力が集まるなら",
    symptoms: ["low_back_pain", "fatigue"],
    headline: "足を膝の真下へ引いてから、鼻を前へ運ぶ",
    text: "足を膝の真下へ引く。鼻をつま先の上へ運ぶ頃、お尻が浮くのを待って立つ",
  ...
  "tension-stairs-center-up": {
    ...
    headline: "一段目だけ、前の足裏を全部置く",
    text: "一段目だけ、前の足裏を段へ全部置く。胸をその膝の上へ運んで上がる",
  ...
  "tension-door-origin-move": {
    scene_family: "push_pull_turn",
    scene: "重い扉や引き出しを、腕だけで引いている時",
    symptoms: ["neck_shoulder", "low_back_pain"],
    headline: "取っ手へ近づき、引く方向へ一歩動く",
    text: "取っ手へ近づいて軽く持つ。引く方向へ片足を一歩動かし、体ごとついていく",
    reason: "腕で頑張る量を、足の一歩が引き受けてくれます。",
    felt_sense: "扉が少し軽く感じたら、その開け方でOK。",
    reset: "ひじが伸び切るなら、取っ手へもう半歩近づこう。",
  },
  "tension-mop-fixed-end": {
    scene_family: "push_pull_turn",
    scene: "モップや掃除機を、腕で大きく振っている時",
    symptoms: ["neck_shoulder", "low_back_pain", "fatigue"],
    headline: "道具を進める方向へ、足も一歩動かす",
    text: "持ち手をおへその前に置き、道具を進める方向へ足も一歩ずつ動かす",
    reason: "肩と腰を何度もねじらずに掃除しやすくなります。",
    felt_sense: "腕より脚が動いている感じならOK。",
    reset: "腰だけが回るなら、掃除する幅を半分にしよう。",
  },
  "tension-kitchen-open-grip": {
    scene_family: "screen_handwork",
    scene: "まな板や器が遠く、肩を前へ出している時",
    symptoms: ["neck_shoulder", "low_back_pain", "fatigue"],
    headline: "まな板や器を、こぶし一つぶん手前へ寄せる",
    text: "まな板や器を、こぶし一つぶん手前へ。ひじを軽く曲げたまま作業する",
...
export function enhanceLifestylePlan({
  ...
  if (!primary) {
    return {
      ...
      trap: "",
      no_suggestion: true,
      no_suggestion_text: "今日は、環境や身体の使い方で足す一手はありません。食べる・ほぐすを見てみてください。",
      selection_basis: {
        primary_kind: "none",
