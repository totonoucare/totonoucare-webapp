...
export const DAILY_CARE_LOGIC_VERSION = "daily_care_v2_30_2026-09-17_continuity";
...
const ENVIRONMENT_ADJUSTMENT_CANDIDATES = [
  {
    id: "prep-morning-layer",
    care_kind: "environment",
    kind_label: "明朝の準備",
    scene_family: "prepare_morning_climate",
    scene_label: "冷え込みへ備える",
    scene: "明朝の冷えや寒暖差に備えるなら",
    text: "今夜のうちに、明朝すぐ重ねられる羽織りと、首元か足元を守る物を一か所へ置く",
    reason: "起きてから冷えを感じた時、探し回らずすぐ調整できます。",
    felt_sense: "朝の支度を想像して、迷わず一枚足せる状態ならOK。",
    reset: "暑く感じたらすぐ外せる、薄い物を一枚だけ選ぼう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "headache", "dizziness", "mood"],
    triggers: ["cold", "temp_shift"],
    requires_weather_match: true,
    policies: ["nukumeru", "sasaeru", "yurumeru"],
    constitution_affinity: { brake: 0.65, reserve_small: 0.7, qi_deficiency: 0.55 },
    care_needs: ["prepare_morning", "reduce_climate_load"],
    item_role: "layering_support",
    shop_eligible: true,
    modes: ["tomorrow"],
    effort: "low",
  },
  {
    ...
    kind_label: "明朝の準備",
    scene_family: "prepare_morning_climate",
    scene_label: "湿気・暑さへ備える",
    scene: "明朝の湿気や暑さに備えるなら",
    text: "寝る前に空気を一度入れ替え、明朝すぐ使えるように換気口や除湿・冷房の設定を確認する",
    reason: "起きてから我慢を重ねる前に、空気を調整しやすくしておけます。",
    felt_sense: "朝に行う操作が一つに決まっていればOK。",
    reset: "冷えすぎるなら、設定温度を下げすぎず風を身体へ直接当てないようにしよう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "headache", "dizziness", "mood"],
    triggers: ["damp", "heat"],
    requires_weather_match: true,
    policies: ["nagasu", "shizumeru", "sasaeru"],
    constitution_affinity: { brake: 0.65, reserve_small: 0.65, fluid_damp: 0.8 },
    care_needs: ["prepare_morning", "reduce_climate_load"],
    item_role: "air_control",
    shop_eligible: true,
    modes: ["tomorrow"],
    effort: "low",
  },
  {
    id: "prep-morning-moisture",
    care_kind: "environment",
    kind_label: "明朝の準備",
    scene_family: "prepare_morning_climate",
    scene_label: "乾燥へ備える",
    scene: "明朝の乾燥に備えるなら",
    text: "今夜、ふた付きの飲み物を手の届く場所へ置き、加湿器を使うなら水量と設定を確認する",
    reason: "起きてから乾きを我慢せず、少量ずつ補いやすくしておけます。",
    felt_sense: "横になったまま無理なく手が届き、倒れにくい場所ならOK。",
    reset: "結露するほど加湿せず、飲み物はこぼれない容器にしよう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "headache", "dizziness", "mood"],
    triggers: ["dry"],
    requires_weather_match: true,
    policies: ["uruosu", "sasaeru"],
    constitution_affinity: { reserve_small: 0.55, fluid_deficiency: 0.9, blood_deficiency: 0.4 },
    care_needs: ["prepare_morning", "support_moisture"],
    item_role: "moisture_support",
    shop_eligible: true,
    modes: ["tomorrow"],
    effort: "low",
  },
  {
    id: "prep-morning-reach",
    care_kind: "environment",
    kind_label: "明朝の準備",
    scene_family: "prepare_morning_route",
    scene_label: "朝の動きを減らす",
    scene: "明朝の動き出しへ備えるなら",
    text: "今夜、明朝最初に使う物を一つだけ、立ち上がってすぐ手が届く場所へ移す",
    reason: "動き出しにくい朝も、最初の用事を小さくできます。",
    felt_sense: "起きて最初に何を取るか、迷わない状態ならOK。",
    reset: "通り道や足元には置かず、安定した台の上へ置こう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "headache", "dizziness", "mood"],
    triggers: ["pressure_down", "pressure_up", "temp_shift", "cold", "heat", "damp", "dry"],
    policies: ["sasaeru", "yurumeru", "shizumeru"],
    constitution_affinity: { reserve_small: 1, qi_deficiency: 0.75, brake: 0.45 },
    care_needs: ["prepare_morning", "reduce_morning_effort"],
    item_role: "morning_layout",
    shop_eligible: true,
    modes: ["tomorrow"],
    effort: "low",
  },
  {
    ...
    scene_label: "湯で温める",
    scene: "夕方以降も冷えやこわばりが残るなら",
    text: "ぬるめの湯へ短く浸かる。全身浴が負担なら、足首が隠れる深さの足湯へ切り替える",
    reason: "冷えたまま休む前に、全身か足元の無理のない方で温まる時間を作れます。",
    felt_sense: "湯から上がったあと、ほっと力が抜ける程度ならOK。",
    reset: "熱さやのぼせを感じたら、湯温を下げるか足湯だけにしよう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "mood"],
    triggers: ["cold", "temp_shift"],
    requires_weather_match: true,
    policies: ["nukumeru", "yurumeru", "meguraseru", "sasaeru"],
    constitution_affinity: { brake: 0.55, reserve_small: 0.5, qi_deficiency: 0.45, blood_stasis: 0.45 },
    care_needs: ["warm_body", "release_tension"],
  ...
  {
    id: "prep-evening-bath-or-footbath",
    care_kind: "environment",
    kind_label: "環境調整",
    scene_family: "prepare_with_bath",
    scene_label: "今夜、湯で温める",
    scene: "明日の冷え込みや寒暖差に備えるなら",
    text: "今夜はぬるめの湯へ短く浸かる。全身浴が負担なら、足首が隠れる深さの足湯へ切り替える",
    reason: "明朝まで冷えを持ち越しにくいよう、今夜のうちに無理のない温め方を選べます。",
    felt_sense: "湯から上がったあと、眠る準備へ移りやすい程度ならOK。",
    reset: "熱さやのぼせを感じたら、湯温を下げるか足湯だけにしよう。",
    symptoms: ["fatigue", "sleep", "digestion", "neck_shoulder", "low_back_pain", "swelling", "mood"],
    triggers: ["cold", "temp_shift"],
    requires_weather_match: true,
    policies: ["nukumeru", "yurumeru", "meguraseru", "sasaeru"],
    constitution_affinity: { brake: 0.55, reserve_small: 0.5, qi_deficiency: 0.45, blood_stasis: 0.45 },
    care_needs: ["prepare_morning", "warm_body"],
    item_role: "bath_shift",
    shop_eligible: true,
    modes: ["tomorrow"],
    effort: "medium",
...
const PUBLIC_ACTION_COPY_BY_ID = {
  ...
  "tension-little-finger-thumb-line": {
    scene_family: "hold_carry",
    symptoms: ["neck_shoulder", "fatigue"],
    headline: "軽いバッグの持ち手を、小指側からそっと包む",
...
function selectFoodIdeas({ catalog, catalogKey, theme, targetDate, symptomFocus, subLabels, limit = 3 }) {
  ...
  const labels = new Set(completed.flatMap((row) => [row.label, ...(row.item_snapshot?.meta?.items || [])]));
