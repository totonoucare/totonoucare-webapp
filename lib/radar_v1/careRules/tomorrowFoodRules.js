...
const TOMORROW_SIGNAL_CONTEXT = {
  low: {
    label: "影響少なめ",
    lead: "明日の天気の影響は少なめ。今夜〜明朝は、いつもの食事に温かさを一つ足すくらいで十分です。",
    choiceBody: "迷ったら、朝か昼に温かい汁物と軽めの主食を足すくらいで大丈夫です。",
  },
  middle: {
    label: "少し響きやすい",
    lead: "明日は少し響きやすい見込み。今夜は「温かいものを一つ足す」「冷たいものや甘いものを重ねない」の2点を決めておきたい日です。",
    choiceBody: "迷ったら、朝は温かい汁物、昼は詰め込みすぎない主食量に寄せます。",
  },
  high: {
    label: "強めに響きやすい",
    lead: "明日は食べ方の影響が体感に出やすい見込み。今夜は深酒・揚げ物・食べすぎを避け、明朝は軽めに始めます。",
...
const SYMPTOM_FOOD_RULES = {
  fatigue: {
    title: {
      ...
      damp: "明日の朝に重だるさを残さない",
      cold: "明日の動き出しに温かさを足す",
      pressure_down: "明日は食べすぎ・空腹の差を小さくする",
    },
    how_to: {
  ...
  sleep: {
    title: {
      default: "今夜は眠りを邪魔しない食べ方へ",
      cold: "寝る前に足首とお腹を冷やさない",
      heat: "今夜は辛味・お酒・濃い味を残さない",
      pressure_down: "首肩の重さを残さず眠る準備をする",
    },
    how_to: {
  ...
  neck_shoulder: {
    title: {
      default: "明日は首肩に重さを残さない",
      pressure_down: "明日は首肩のこもりを増やさない",
      cold: "今夜から首元と胃腸を冷やさない",
      dry: "明日は首肩の乾き・こわばりに汁気を足す",
    },
    how_to: {
  ...
  low_back_pain: {
    title: {
      default: "明日は腰腹を冷やさない",
      damp: "明日は腰まわりに重だるさを残さない",
      cold: "今夜から腰腹を冷やさない食べ方へ",
      pressure_down: "明日は腰まわりに重さを残さない",
    },
    how_to: {
  ...
  swelling: {
    title: {
      default: "明日はむくみを増やさない",
      damp: "今夜は甘さ・冷たさ・塩気を重ねない",
      heat: "明日は水分を一気に入れず小分けにする",
      cold: "足元を冷やさず、むくみを残さない",
    },
    how_to: {
  ...
  headache: {
    title: {
      default: "明日は頭の重さを増やさない",
      pressure_down: "今夜はお酒と脂っこさを重ねない",
      damp: "明日は頭に重さを残さない",
      cold: "今夜から首元と胃腸を冷やさない",
      dry: "明日は目と喉の乾きを残さない",
    },
  ...
  dizziness: {
    title: {
      default: "明日は空腹と急な動き出しを避ける",
      pressure_down: "明日は空腹と食べすぎの差を小さくする",
      heat: "明日は水分を小分けにして備える",
      cold: "明日は足元まで冷やさない",
    },
    how_to: {
  ...
  mood: {
    title: {
      default: "明日は気分を急に上げ下げしない",
      pressure_down: "甘さとカフェインだけで押し切らない",
      heat: "今夜は辛味・濃い味・カフェインを足しすぎない",
      cold: "温かい食事で体を縮こませない",
    },
    how_to: {
