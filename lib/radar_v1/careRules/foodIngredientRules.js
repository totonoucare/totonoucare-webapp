...
const FOOD_ITEMS = [
  // 主食
  { name: "ごはん", role: "staple", tags: ["support_spleen", "qi", "neutral", "easy", "fluids"], note: "胃腸を支える土台に" },
  { name: "玄米", role: "staple", tags: ["support_spleen", "fiber", "drain_damp"], anti: ["digestion_weak", "dry"], note: "重だるさの日の主食に" },
  { name: "もち麦", role: "staple", tags: ["fiber", "drain_damp", "light"], anti: ["dry"], note: "湿気や重さが気になる時に" },
  { name: "うどん", role: "staple", tags: ["support_spleen", "easy", "warm"], note: "胃腸が重い日の温かい主食に" },
  ...
  // 肉・卵
  { name: "鶏肉", role: "protein", tags: ["warm", "qi", "support_spleen", "protein"], note: "胃腸を支えたい日の主菜に" },
  ...
  { name: "羊肉", role: "protein", tags: ["warm_hot", "kidney", "qi", "protein"], anti: ["heat", "pressure_up", "dry"], note: "冷えが強い日の温めに" },
  ...
  // 魚介
  { name: "鮭", role: "protein", tags: ["warm", "qi", "support_spleen", "protein"], note: "補いながら重くしにくい魚に" },
  ...
  { name: "えび", role: "protein", tags: ["warm", "kidney", "protein"], anti: ["heat"], note: "足腰まわりを支えたい時に" },
  ...
  { name: "小豆", role: "bean", mealGroup: "side", tags: ["drain_damp", "light", "sea"], note: "水はけを意識したい時に" },
  { name: "黒豆", role: "bean", mealGroup: "side", tags: ["kidney", "blood", "support", "neutral"], note: "冷やしすぎず補う" },
  { name: "緑豆", role: "bean", mealGroup: "side", tags: ["clear_heat", "drain_damp", "cool"], anti: ["cold"], note: "暑湿の日に軽く使う" },
  ...
  { name: "シナモン", role: "seasoning", tags: ["warm_hot", "kidney", "move_blood"], anti: ["heat", "pressure_up", "dry"], note: "冷えが強い日に少量" },
