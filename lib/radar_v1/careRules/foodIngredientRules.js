...
const DRINK_WEATHER_BODY = {
  ...
  cold: "冷えの日は、飲み物で内側からこわばりを足さないことが大事です。温かい一杯をひとつ混ぜるだけでも、お腹まわりを冷やしにくくなります。",
...
const FOOD_VOICE_REASONS = {
  damp: "湿気の日は、胃腸に水分を含んだような重さが残りやすい日です。冷たいもの・甘いもの・脂っこいものが続くと、胃腸の重さが全身のだるさにつながりやすくなります。今日は、軽く流れる食べ方に寄せます。",
  cold: "冷え込みの日は、胃腸の動きが鈍くなりやすい日です。冷たいものだけで済ませると、内側からこわばりや重さが残りやすくなります。今日は、温かいものを一つ足して、お腹まわりを冷やしにくくします。",
  heat: "暑さの日は、体の熱を逃がしたいのに、刺激でさらに熱感を強めやすい日です。辛いもの・濃い味・脂っこいものが重なると、だるさやそわつきにつながりやすくなります。今日は、熱をこもらせない食べ方に寄せます。",
...
const FOOD_VOICE_AVOID = {
  ...
  dry: ["乾いたお菓子だけで、体の乾きを重ねる", "空腹でコーヒーだけを流し込み、水分を補わない", "辛いもので乾きに刺激を足す"],
  pressure_down: ["食事を抜いてカフェインだけで、ぼんやりを押し切る", "揚げ物と甘いものばかりで、重さに追い打ちをかける", "お酒と脂っこいもので、頭と胃腸をさらに重くする"],
  pressure_up: ["辛いもののあとにコーヒーで、前のめりを加速させる", "濃い味を早食いして、胃腸の負担を増やす", "塩辛いものとお酒で、力みを長引かせる"],
...
const FOOD_VOICE_SYMPTOM_REASONS = {
  ...
  neck_shoulder: " 首肩を見ている時は、内側の冷えや重さが首肩の負担につながることも見ています。",
  low_back_pain: " 腰を見ている時は、腰腹まわりを冷やしすぎない食べ方も一緒に見ます。",
  swelling: " むくみを見ている時は、冷たさ・甘さ・塩気の重なりを減らすことも見ています。",
