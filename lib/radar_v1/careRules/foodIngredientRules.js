...
const DRINK_WEATHER_BODY = {
  damp: "湿気の日は、冷たい甘い飲み物ばかりに偏ると、食後の重さが残ることがあります。甘くないお茶や温かい飲み物も候補にします。",
  cold: "冷えの日は、お腹まで冷やさない飲み物を選びます。いつもの飲み物に、温かい一杯を一つ加えるだけでも十分です。",
  heat: "暑い日は、辛味やカフェインの強い飲み物を増やさず、冷やしすぎない一杯を選びます。",
  dry: "のど・目・肌がカサつく日は、飲み物が水分を補う助けになります。カフェインだけでつなぐより、乾いた感じをそのままにしない一杯を候補にします。",
  pressure_down: "低気圧の日は、眠気やだるさからコーヒーを増やしたくなることがあります。飲むなら朝から昼の少量にし、食事や水分も一緒に取ります。",
  pressure_up: "気圧上昇の日は、気持ちが急ぎやすくなることがあります。コーヒーや濃いお茶を続けず、カフェインの少ない飲み物も候補にします。",
