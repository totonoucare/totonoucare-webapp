...
function getTodayLifestylePlan(primaryKey, secondaryKey, signal, symptomFocus) {
  ...
  return applyTodayLifestyleVoice(withTodaySymptomFocus(plan, key, symptomFocus, level), key, symptomFocus);
}
...
// v7.30: 今日タブの暮らしケアは、予定管理より「体の状態を翻訳する」文体へ寄せる。
const TODAY_LIFESTYLE_VOICE_BY_TRIGGER = {
  damp: {
    title: "湿気をためない日中ケア",
    lead: "今日は、体が湿気を抱え込みやすい日。気合いで押し切るより、空気・姿勢・胃腸の重さを外に逃がします。",
    steps: [
      "5分だけ換気して、体にまとわりつく重さを外へ逃がす",
      "肩か足首を30秒だけ動かして、体のスリープモードを解除する",
      "食後に2〜3分だけ歩いて、胃腸を止めっぱなしにしない",
      "服・ベルト・姿勢を少しゆるめて、胸とお腹の通り道を作る",
    ],
    trap: "今日は、がんばる量を増やすより、体の重さを増やさないことが先です。冷たい・甘い・脂っこいを重ねすぎないようにします。",
  },
  pressure_down: {
    title: "頭と首肩のこもりを逃がす日中ケア",
    lead: "今日は、頭・耳・首肩にこもる重さが出やすい日。カフェインで押し切るより、上半身の逃げ道を作ります。",
    steps: [
      "耳まわりを10秒だけゆるめて、頭のこもりを逃がす",
      "画面から目を離し、首の後ろをふわっと長くする",
      "肩をすくめてストンと落とす動きを3回だけ入れる",
      "空腹のまま粘らず、軽く食べてから動く",
    ],
    trap: "ぼんやりを気合いとカフェインだけで押し切ると、あとで首肩や頭に重さが集まりやすくなります。",
  },
  pressure_up: {
    title: "前のめりの力みをほどく日中ケア",
    lead: "今日は、体が知らないうちに前のめりになりやすい日。急いで整えるほど、肩と頭に力が集まりやすくなります。",
    steps: [
      "肩をすくめて、息を吐きながらストンと落とす",
      "手首か足首を30秒だけ回して、力みの出口を作る",
      "濃い味・辛いもの・カフェインを重ねすぎない",
      "焦りを感じたら、体のどこに力が入っているか一か所だけ見る",
    ],
    trap: "一気に片付けようとするほど、首肩・頭・胸まわりが固まりやすい日です。",
  },
  cold: {
    title: "冷えをこわばりに変えない日中ケア",
    lead: "今日は、体の入口がきゅっと縮みやすい日。冷え切ってから戻すより、足首・お腹・首元のどこか一つを先に守ります。",
    steps: [
      "足首・お腹・首元のどこか一つを温める",
      "冷たい飲み物を続けず、温かい一口を挟む",
      "動き出す前に、肩か骨盤を小さく動かす",
      "外に出る前に、首元か腰元の冷えだけ確認する",
    ],
    trap: "薄着と冷たい飲み物が重なると、体が防御モードに入りやすくなります。",
  },
  heat: {
    title: "熱をこもらせない日中ケア",
    lead: "今日は、暑さで体力のバッテリーが減りやすい日。我慢で突破するより、熱が上にこもる前に逃がします。",
    steps: [
      "暑さを我慢しすぎず、涼しい場所に一度逃がす",
      "水分を一気飲みせず、少しずつ入れる",
      "首の後ろを短時間だけ冷まして、熱の出口を作る",
      "辛いもの・濃い味・カフェインを重ねすぎない",
    ],
    trap: "暑さに刺激を重ねると、疲れ・そわつき・寝つきに回収されやすい日です。",
  },
  dry: {
    title: "うるおいを削らない日中ケア",
    lead: "今日は、内側のうるおいが少し削られやすい日。のど・目・肌の乾きが、疲れやこわばりに変わる前に守ります。",
    steps: [
      "喉が渇く前に、温かい飲み物を一口入れる",
      "目を10秒だけ閉じて、画面の乾いた疲れを切る",
      "空調の風が顔に直接当たらないようにする",
      "乾いたお菓子とコーヒーだけで空腹をつながない",
    ],
    trap: "乾きは小さい不快感として始まります。放っておくと、目・のど・首肩の疲れに変わりやすい日です。",
  },
  default: {
    title: "体の重いタブを一つ閉じる日中ケア",
    lead: "今日は、強い対策より小さな調整が合う日。体の重いタブを一つ閉じるつもりで整えます。",
    steps: [
      "考える前に、肩か足首を30秒だけ動かす",
      "空気・姿勢・飲み物のどれか一つを軽く変える",
      "違和感が出る前に、一度だけ深く息を吐く",
    ],
    trap: "正解を探しすぎるより、体が軽くなる一手を小さく試す方が合います。",
  },
};

const TODAY_LIFESTYLE_VOICE_BY_SYMPTOM = {
  fatigue: {
    lead: "だるさは気合い不足ではなく、体の起動に時間がかかっているサインかもしれません。",
    step: "やる気を待つより、足踏み30秒で体のスイッチを先に入れる",
  },
  sleep: {
    lead: "睡眠を見ている日は、夜の休み方まで日中の光・胃腸・首肩の重さが残りやすいです。",
    step: "夕方以降の画面と光を、一度だけ早めに区切る",
  },
  digestion: {
    lead: "胃腸を見ている日は、食べ方が体全体の交通整理役になります。",
    step: "食後に2〜3分だけ歩いて、胃腸を止めっぱなしにしない",
  },
  neck_shoulder: {
    lead: "首肩を見ている日は、首本人を責めるより、胸・肩甲骨・目の使い方からほどく方が合います。",
    step: "首をいきなり回さず、肩甲骨をゆっくり寄せて離す",
  },
  low_back_pain: {
    lead: "腰を見ている日は、腰だけでなく足元・お腹・座り方の影響も見たい日です。",
    step: "立ち上がる前に、骨盤を小さく揺らして腰の起動準備をする",
  },
  swelling: {
    lead: "むくみを見ている日は、水はけのスイッチを足元から入れるのが合います。",
    step: "足首をゆっくり回して、ため込む前に流れを作る",
  },
  headache: {
    lead: "頭痛を見ている日は、頭だけでなく首・耳・目まわりも一緒に見たい日です。",
    step: "首・耳・目まわりを先にゆるめて、頭だけに仕事を集めない",
  },
  dizziness: {
    lead: "めまいを見ている日は、急な動きより“動き出しの一拍目”をゆっくりにします。",
    step: "立つ・振り向く・歩き出す前に、一呼吸だけ入れる",
  },
  mood: {
    lead: "気分を見ている日は、気分そのものより体の重さに引っぱられていないかを見ます。",
    step: "気分を直接上げようとせず、肩か足首を30秒だけ動かす",
  },
};

function applyTodayLifestyleVoice(plan, primaryKey, symptomFocus) {
  const key = normalizeTriggerKey(primaryKey);
  const voice = TODAY_LIFESTYLE_VOICE_BY_TRIGGER[key] || TODAY_LIFESTYLE_VOICE_BY_TRIGGER.default;
  const symptomVoice = TODAY_LIFESTYLE_VOICE_BY_SYMPTOM[symptomFocus] || null;
  ...
  return {
    ...plan,
    title: voice.title || plan.title,
    lead: symptomVoice?.lead ? `${symptomVoice.lead} ${voice.lead}` : voice.lead || plan.lead,
    steps: steps.length ? steps : plan.steps,
    trap: voice.trap || plan.trap,
  };
}
