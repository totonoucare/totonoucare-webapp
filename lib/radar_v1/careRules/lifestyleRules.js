...
const TODAY_LIFESTYLE_VOICE_BY_TRIGGER = {
  damp: {
    title: "湿気をためない日中ケア",
    lead: "今日は、体が湿気を抱え込みやすい日。気合いで押し切るより、空気・姿勢・胃腸の重さを外に逃がします。除湿・換気・通気を助けるものがあれば、ここで使う日です。",
    steps: [
  ...
  pressure_down: {
    ...
    lead: "今日は、頭・耳・首肩にこもる重さが出やすい日。カフェインで押し切るより、上半身の逃げ道を作ります。温めるものや目を休ませるものがあれば、短く借ります。",
    steps: [
  ...
  cold: {
    ...
    lead: "今日は、体の入口がきゅっと縮みやすい日。冷え切ってから戻すより、足首・お腹・首元のどこか一つを先に守ります。カイロや腹巻き系は“冷えてから”より“冷える前”が出番です。",
    steps: [
      "足首・お腹・首元のどこか一つを温める",
...
const TOMORROW_LIFESTYLE_VOICE_BY_TRIGGER = {
  ...
  heat: {
    title: "明日の熱をためない支度",
    lead: "明日は暑さで消耗しやすい見込み。今夜は涼しさと水分の候補を先に決めて、明日の体力バッテリーを守ります。",
    steps: [
      "寝る前に部屋の熱気を逃がしてから休む",
