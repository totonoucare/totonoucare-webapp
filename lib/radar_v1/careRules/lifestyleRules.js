...
const TODAY_LIFESTYLE_FOCUS_RULES = {
  fatigue: {
    ...
    cold: {
      lead: "冷えで動き始めにくい日は、頑張る前に温める場所を決めます。",
      ...
      lead: pickBySeverity(
        {
          ...
          middle: "今日は冷えや寒暖差がこわばりにつながりやすい日です。腰腹・足元・首元のどれか一つを先に守ります。",
...
function getTomorrowLifestylePlan(primaryKey, secondaryKey, signal, symptomFocus) {
  ...
  if (keys.has("damp")) {
      ...
      lead: pickBySeverity(
        {
          ...
          middle: "明日は冷え込みや寒暖差がこわばりにつながりやすい見込みです。寝る前の足元・腰腹まわりを守ります。",
      ...
      lead: pickBySeverity(
        {
          ...
          high: "明日は暑さの影響が強く出やすい見込みです。今夜は部屋と身体の熱を減らし、疲れを増やさないことを優先します。",
        },
        level,
      ),
      steps: [
    ...
    plan = {
      ...
      lead: pickBySeverity(
        {
          low: "明日は体に少し力が入りやすい見込みです。短くても、休む前の切り替えを入れます。",
    ...
    plan = {
      ...
      lead: pickBySeverity(
        {
          ...
          middle: "明日は少し体調を崩しやすい見込みです。今夜は早めに準備を済ませ、休む時間を確保しましょう。",
      ...
      trap: "調子がよい日も、いつもの睡眠時間と食事のペースを保ちましょう。",
    };
  }

  return applyTomorrowLifestyleVoice(withTomorrowSymptomFocus(plan, symptomFocus, level), primaryKey, symptomFocus);
}
...
const TODAY_LIFESTYLE_VOICE_BY_TRIGGER = {
  damp: {
    title: "湿気をためない日中ケア",
    lead: "今日は、湿気で体が重だるくなりやすい日。気合いで押し切るより、空気・姿勢・胃腸の負担を軽くします。除湿・換気・通気を助けるものがあれば、ここで使う日です。",
    steps: [
      "5分だけ換気して、湿気による重だるさをためにくくする",
      "除湿・サーキュレーター・吸湿系など、空気を軽くする道具を一つ使う",
      "食後に2〜3分だけ歩いて、食後の重さを残しにくくする",
  ...
  pressure_down: {
    ...
    lead: "今日は、頭・耳・首肩にこもる重さが出やすい日。カフェインで押し切るより、頭と首肩の負担をゆるめます。温めるものや目を休ませるものがあれば、短く使います。",
    steps: [
      "耳まわりを10秒だけゆるめて、頭のこもりを逃がす",
      "アイピローや温熱系があれば、目・首肩を短く休ませる",
  ...
  cold: {
    ...
    lead: "今日は、冷えで体がこわばりやすい日。冷え切ってから戻すより、足首・お腹・首元のどこか一つを先に守ります。カイロや腹巻き系は“冷えてから”より“冷える前”が出番です。",
    steps: [
      "足首・お腹・首元のどこか一つを温める",
      "カイロ・腹巻き・レッグウォーマーなど、守る道具を一つ使う",
      "冷たい飲み物を続けず、温かい一口を挟む",
      "動き出す前に、肩か骨盤を小さく動かす",
    ],
  ...
  heat: {
    title: "熱をこもらせない日中ケア",
    lead: "今日は、暑さで体力を消耗しやすい日。我慢で突破するより、熱が上にこもる前に逃がします。",
    steps: [
      "暑さを我慢しすぎず、涼しい場所に一度逃がす",
      "水分を一気飲みせず、少しずつ入れる",
      "首の後ろを短時間だけ冷まして、熱を逃がす",
      "辛いもの・濃い味・カフェインを重ねすぎない",
    ],
    trap: "暑さに刺激を重ねると、疲れ・そわつき・寝つきにくさにつながりやすい日です。",
  },
  dry: {
    title: "うるおいを削らない日中ケア",
  ...
  default: {
    title: "体の負担を一つ減らす日中ケア",
    lead: "今日は、強い対策より小さな調整が合う日。体の負担を一つ減らすところから整えます。",
    steps: [
      "考える前に、肩か足首を30秒だけ動かす",
...
const TODAY_LIFESTYLE_VOICE_BY_SYMPTOM = {
  fatigue: {
    lead: "だるさは気合い不足ではなく、身体が動き始めるまでに時間が必要なサインかもしれません。",
    step: "やる気を待つより、足踏み30秒で体を動き始めやすくする",
  },
  sleep: {
  ...
  digestion: {
    lead: "胃腸を見ている日は、食べ方が体全体の重さにも影響しやすくなります。",
    step: "食後に2〜3分だけ歩いて、食後の重さを残しにくくする",
  },
  neck_shoulder: {
    lead: "首肩が気になる日は、首だけに原因を求めず、胸・肩甲骨・目の使い方からほどく方が合います。",
    step: "首をいきなり回さず、肩甲骨をゆっくり寄せて離す",
  },
  low_back_pain: {
    lead: "腰を見ている日は、腰だけでなく足元・お腹・座り方の影響も見たい日です。",
    step: "立ち上がる前に、骨盤を小さく揺らして腰を動かす準備をする",
  },
  swelling: {
    lead: "むくみを見ている日は、足元から巡りを促すのが合います。",
    step: "足首をゆっくり回して、ため込む前に流れを作る",
  },
  headache: {
    lead: "頭痛を見ている日は、頭だけでなく首・耳・目まわりも一緒に見たい日です。",
    step: "首・耳・目まわりを先にゆるめて、頭だけに負担を集めない",
  },
  dizziness: {
...
const TOMORROW_LIFESTYLE_VOICE_BY_TRIGGER = {
  damp: {
    title: "明日の湿気に備える寝室づくり",
    lead: "明日は湿気の負担が続く見込みです。今夜は寝室の湿度や寝具の湿りを確認し、必要に応じて除湿しましょう。",
    steps: [
      "寝室が蒸すときは除湿する。外の空気が乾いていれば、短く換気する",
      "部屋干し・濡れタオル・湿った寝具を、寝る場所から少し離す",
      "明日の朝用に、温かい飲み物や軽い汁物を候補に入れておく",
      "足元かお腹を冷やさない服装を先に選ぶ",
    ],
    trap: "まずは寝室の湿度と寝具の湿りを確認し、できることを一つ試しましょう。",
  },
  pressure_down: {
    title: "明日のこもりを抜く前夜ケア",
    lead: "明日は頭・耳・首まわりにこもりが出やすい見込み。今夜は画面姿勢を引っぱらず、首肩を休ませるものを先に出しておきます。",
    steps: [
      "寝る前に耳まわりを軽くゆるめて、首の後ろを長くする",
      "アイピロー・温熱系・首肩を休ませるものがあれば、短く使う",
      "枕元に水を置き、明日の朝に一口飲めるようにする",
      "明日の注意時間に備えて、ケアするツボを一つ確認しておく",
    ],
    trap: "寝る直前まで画面を見続けて首を固めると、明日のこもり感が残りやすくなります。",
  },
  pressure_up: {
    title: "明日の力みをほどく前夜ケア",
    lead: "明日は体が前のめりになりやすい見込み。今夜は予定を片づけ切るより、肩と胸の力を抜くきっかけを先に置きます。",
    steps: [
      "寝る30分前だけ、通知を見ない時間を作る",
      "香り・温かい飲み物・手首足首ケアなど、力を抜く候補を一つ選ぶ",
      "肩をすくめて、息を吐きながらストンと落とす",
      "明日の予定を一つだけ外に書き出して、頭の中から出す",
    ],
    trap: "明日の準備をしすぎて頭が前のめりになると、休んだのに力みが残りやすくなります。",
  },
  cold: {
    title: "明日の冷えを入口で止める支度",
    lead: "明日は冷えがこわばりに変わりやすい見込み。今夜のうちに、足首・お腹・首元を守るものを手に取りやすい場所へ出しておきます。",
    steps: [
      "足首・お腹・首元のどこか一つを温かくして寝る",
      "カイロ・腹巻き・レッグウォーマーなど、明日使う候補を出しておく",
      "朝使う上着や靴下を、寝る前に手に取りやすい場所へ置く",
      "シャワーだけの日は、足先に少し長めに温水を当てる",
    ],
    trap: "明日の冷え対策は、朝になって探すより、今夜のうちに“守る場所”と道具を決めておく方が続きます。",
  },
  heat: {
    title: "明日の熱をためない支度",
    lead: "明日は暑さで消耗しやすい見込み。今夜は涼しさと水分の候補を先に決めて、明日の消耗を増やさないようにします。",
    steps: [
      "寝る前に部屋の熱気を逃がしてから休む",
      "麦茶・水筒・冷感タオルなど、明日の熱を逃がす候補を用意する",
      "入浴後すぐ布団に入らず、汗が引いてから休む",
      "辛いもの・濃い味・カフェインを夜に重ねすぎない",
    ],
    trap: "明日持ち歩く飲み物や暑さ対策の道具を、今夜のうちに用意しましょう。",
  },
  dry: {
    title: "明日の乾きを増やさない支度",
    lead: "明日は乾きが小さな疲れに変わりやすい見込み。今夜は加湿・保湿・のど/目を守るものを先に用意します。",
    steps: [
      "枕元に水を置き、寝る前と起床後に一口飲めるようにする",
      "加湿・保湿・のどを守るものを、寝る前の動線に置く",
      "エアコンの風が顔に直接当たらない向きに変える",
      "洗顔後や入浴後は、乾く前に保湿まで済ませる",
    ],
    trap: "乾きは小さく始まります。明日の朝に探すより、今夜のうちに使うものを一つ置いておきます。",
  },
  default: {
    title: "明日の自分が迷わない前夜ケア",
    lead: "今夜のうちに、明日の朝に行うケアを一つ決めておきましょう。使うものも用意しておくと、取りかかりやすくなります。",
    steps: [
      "明日の朝に使うものを一つだけ出しておく",
      "寝る前のスマホ時間を少し短くする",
      "首肩かお腹のどちらか一つだけ、冷やさないようにする",
    ],
    trap: "整えようとして準備を増やしすぎると続きません。明日の候補は一つで十分です。",
  },
};

const TOMORROW_LIFESTYLE_VOICE_BY_SYMPTOM = {
  fatigue: {
    lead: "だるさを見ている日は、明日の動き始めを助ける道具や飲み物も先に決めておくと楽です。",
    step: "明日の朝に使う飲みもの・温めるもの・短い運動のどれか一つを用意する",
  },
  sleep: {
    lead: "睡眠を見ている日は、眠る努力より“邪魔を減らす道具立て”が効きやすいです。",
    step: "寝る前に、画面・光・通知を遠ざけるものを一つ決める",
  },
  digestion: {
    lead: "胃腸を見ている日は、明日の朝に重くならない飲みものや汁物の候補を先に見ると選びやすくなります。",
    step: "明日の朝に飲むものか汁物を一つ候補に入れておく",
  },
  neck_shoulder: {
    lead: "首肩を見ている日は、明日の注意時間前に使える温熱・ほぐし系の候補を出しておくと使いやすいです。",
    step: "首肩を休ませるものを、寝る前か明日の作業前に使える場所へ置く",
  },
  low_back_pain: {
    lead: "腰を見ている日は、明日の動き出しを助ける温め・支える・足元ケアの候補を先に見ます。",
    step: "明日の朝に腰腹か足元を守るものを一つ出しておく",
  },
  swelling: {
    lead: "むくみを見ている日は、足元の水はけを助けるものと飲みものの候補を今夜のうちに見ておきます。",
    step: "寝る前に足首を回し、明日の飲みもの候補を一つ決める",
  },
  headache: {
    lead: "頭痛を見ている日は、首・耳・目まわりを休ませる候補を今夜のうちに用意しておくと使いやすいです。",
    step: "目を休ませるものか首肩をゆるめるものを、手に届く場所へ置く",
  },
  dizziness: {
    lead: "めまいを見ている日は、明日の動き出しを急がない環境づくりを先にします。",
    step: "明日の朝に使うものを枕元に寄せ、立ち上がりを急がない準備をする",
  },
  mood: {
    lead: "気分を見ている日は、明日の自分が選びやすいように、飲みもの・香り・ほぐす場所を一つだけ決めておきます。",
    step: "明日の気分を無理に上げるものではなく、体を軽くする候補を一つ出す",
  },
};

function applyTomorrowLifestyleVoice(plan, primaryKey, symptomFocus) {
  const key = normalizeTriggerKey(primaryKey);
  const voice = TOMORROW_LIFESTYLE_VOICE_BY_TRIGGER[key] || TOMORROW_LIFESTYLE_VOICE_BY_TRIGGER.default;
  const symptomVoice = TOMORROW_LIFESTYLE_VOICE_BY_SYMPTOM[symptomFocus] || null;
  const steps = Array.from(new Set([
    symptomVoice?.step,
    ...(voice.steps || []),
  ].filter(Boolean))).slice(0, 4);
  ...
  return {
    ...plan,
    title: voice.title || plan.title,
    lead: symptomVoice?.lead ? `${voice.lead} ${symptomVoice.lead}` : voice.lead || plan.lead,
    steps: steps.length ? steps : plan.steps,
    trap: voice.trap || plan.trap,
  };
}
