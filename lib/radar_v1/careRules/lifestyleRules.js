...
const TODAY_LIFESTYLE_VOICE_BY_SYMPTOM = {
  fatigue: {
    lead: "だるさは気合い不足ではなく、体が動き出すまでに時間がかかっているサインかもしれません。",
...
const TOMORROW_LIFESTYLE_VOICE_BY_TRIGGER = {
  damp: {
    ...
    lead: "明日は体に湿気がまとわりつきやすい見込み。今夜は根性より、寝室・服・飲みものの湿気を軽くしておきます。除湿・通気・寝具まわりの候補を先に見ておくと、明日の朝が選びやすくなります。",
    steps: [
      "寝る前に5分だけ換気するか、除湿で空気を一度軽くする",
      "部屋干し・濡れタオル・湿った寝具を、寝る場所から少し離す",
      "明日の朝用に、温かい飲み物や軽い汁物を候補に入れておく",
      "足元かお腹を冷やさない服装を先に選ぶ",
    ],
    trap: "明日の湿気対策は、完璧な養生より“寝室の重さを減らす道具”を一つ決めるくらいで十分です。",
  },
  pressure_down: {
    title: "明日のこもりを抜く前夜ケア",
  ...
  heat: {
    ...
    trap: "暑さ対策は、気合いより先に道具と飲みもの。明日の外出前に迷わない形にしておきます。",
  },
  dry: {
    title: "明日の乾きを増やさない支度",
  ...
  default: {
    ...
    lead: "明日は大きく構えすぎるより、使う道具・飲みもの・ほぐす場所を一つだけ決めておく日。選択肢を減らすほど、朝のケアにつながりやすくなります。",
    steps: [
      "明日の朝に使うものを一つだけ出しておく",
      "寝る前のスマホ時間を少し短くする",
      "首肩かお腹のどちらか一つだけ、冷やさないようにする",
...
const TOMORROW_LIFESTYLE_VOICE_BY_SYMPTOM = {
  fatigue: {
    lead: "だるさを見ている日は、明日の動き始めを軽くする道具や飲みものも先に決めておくと楽です。",
