...
const SIGNAL_FOOD_CONTEXT = {
  ...
  middle: {
    label: "シグナル中くらい",
    lead: "午後〜夜に残りやすいので、足すものと重ねすぎを一つずつ決めておきたい日です。",
...
const TRIGGER_FOOD_RULES = {
  ...
  cold: {
    ...
    reason:
      "気温差や冷え込みがある日は、食事の温度がそのままこわばりの残り方に出やすい前提で組みます。",
  ...
  heat: {
    title: "熱をこもらせない軽さを足す",
    recommendation:
      "辛いもの・濃い味・カフェインで押し切るより、軽い汁気やみずみずしいものを入れて、熱の逃げ道を残します。",
    how_to:
      "昼〜夕方のどこかで、水分と塩気を少し補い、濃い味を重ねすぎないようにします。食事は“軽く整える”くらいで十分です。",
    avoid: "暑さに加えて辛味・アルコール・カフェインを重ねる。",
    reason:
      "暑さが響く日は、頑張るための刺激が“内側の熱っぽさ”として残りやすい前提で組みます。",
  ...
  dry: {
    ...
    reason:
      "乾燥が響く日は、喉だけでなく頭や首肩の張りにもつながりやすい前提で組みます。",
  ...
  pressure_down: {
    ...
    reason:
      "気圧変化が響く日は、胃腸の重さと首肩のこわばりが一緒に出ると体感が悪くなりやすい前提で組みます。",
  ...
  pressure_up: {
    ...
    reason:
      "張りつめやすい日は、刺激の重なりが夜のこわばりや気分の落ち着かなさに残りやすい前提で組みます。",
  ...
  default: {
    ...
    reason: "天気のぶれがある日は、食べ方の負担が体感に上乗せされやすい前提で組みます。",
...
const SYMPTOM_FOOD_RULES = {
  fatigue: {
    title: {
      default: "だるさを増やさない軽い一品を足す",
      damp: "湿気×だるさは、重さを残さない一品を足す",
      cold: "冷え×だるさは、温かい主食か汁物を足す",
      pressure_down: "低気圧×だるさは、詰め込まずに温かさを足す",
    },
    how_to: {
    ...
    avoid: {
      default: "甘いものやカフェインだけで山場を越えようとする。",
  ...
  sleep: {
    title: {
      default: "夜に刺激を残さない食べ方へ",
      cold: "冷え×睡眠は、寝る前に冷やさない一品を足す",
      heat: "暑さ×睡眠は、熱をこもらせない食べ方へ",
      pressure_down: "低気圧×睡眠は、首肩を重くしない軽さへ",
    },
    how_to: {
  ...
  neck_shoulder: {
    title: {
      default: "首肩を詰まらせない軽い温かさを足す",
      pressure_down: "低気圧×首肩は、こもらせない食べ方へ",
      cold: "冷え×首肩は、首元と内側を冷やさない",
      dry: "乾燥×首肩は、汁気を少し足す",
    },
    how_to: {
      default: "温かい飲み物か汁物を足して、甘いもの・カフェインだけで首肩の山場を押し切らない形にします。",
    ...
    avoid: {
      ...
      pressure_down: "脂っこいものや甘いもので押し切って、そのまま首を固める。",
    },
    examples: {
      default: ["温かいお茶", "味噌汁", "おにぎり＋汁物"],
  ...
  low_back_pain: {
    title: {
      default: "腰腹を冷やさない食べ方へ",
      damp: "湿気×腰は、下半身を重くしない食べ方へ",
      cold: "冷え×腰は、温かい汁物・ごはん系を足す",
      pressure_down: "低気圧×腰は、重さを増やさない軽さへ",
    },
    how_to: {
    ...
    reason: "腰が気になる日は、冷えや食後の重さが腰腹・骨盤まわりのこわばりに残りやすい前提で組みます。",
    lifestyle_tip: "食後は深く座り込む前に、骨盤まわりを小さく動かします。",
  },
  swelling: {
    title: {
      default: "むくみを増やさない食べ方へ",
      damp: "湿気×むくみは、甘さ・冷たさ・塩気を重ねない",
      heat: "暑さ×むくみは、水分を小分けに足す",
  ...
  headache: {
    title: {
      default: "頭をこもらせない食べ方へ",
      pressure_down: "低気圧×頭痛は、脂っこさと刺激を重ねない",
      damp: "湿気×頭痛は、重さを増やさない軽さへ",
      cold: "冷え×頭痛は、首元を冷やさない温かさへ",
      dry: "乾燥×頭痛は、目と喉に汁気を足す",
    },
    how_to: {
      default: "温かい飲み物か軽い汁物を足して、空腹のままカフェインや甘いもので押し切らない形にします。",
    ...
    reason: "頭痛が気になる日は、空腹・刺激・食後の重さが首肩や耳まわりのこもりに重なりやすい前提で組みます。",
    lifestyle_tip: "食後は首を起こし、耳まわりを軽くゆるめてから画面に戻ります。",
  },
  dizziness: {
    title: {
      default: "ふわつきを増やさない食べ方へ",
      pressure_down: "低気圧×めまいは、空腹と詰め込みを避ける",
      heat: "暑さ×めまいは、水分を小分けに足す",
  ...
  mood: {
    title: {
      default: "気分を揺らしすぎない食べ方へ",
      pressure_down: "低気圧×気分は、甘さとカフェインで押し切らない",
      heat: "暑さ×気分は、刺激を足しすぎない",
    ...
    avoid: {
      default: "甘いものとカフェインだけで山場を越えようとする。",
