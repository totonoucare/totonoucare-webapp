...
const SYMPTOM_FOOD_ITEMS = {
  ...
  digestion: {
    ...
    caution: {
      ...
      damp: ["冷たい飲み物＋甘いもの", "パン・麺＋カフェラテ", "揚げ物＋食べすぎ"],
...
const SYMPTOM_FOOD_RULES = {
  ...
  digestion: {
    title: {
      default: "今日は胃腸を重くしない食べ方",
      damp: "今日は胃腸に湿気の重さを残さない食べ方",
      pressure_down: "今日は胃腸の動きを重くしない食べ方",
      cold: "今日はお腹を冷やさない食べ方",
      heat: "今日は冷やしすぎで胃腸を疲れさせない食べ方",
    },
    how_to: {
      default: "温かい汁物やお茶を足して、量や刺激で押し切らない食べ方にします。",
      damp: "温かい汁物・香味・軽めの主食のどれかを足して、冷たさと甘さを重ねない形にします。",
      pressure_down: "小さめ主食や軽いスープを足して、脂っこさや食べすぎで胃腸の重さを増やさないようにします。",
      cold: "味噌汁・雑炊・温かい飲み物のどれかを足して、お腹まわりを冷やしすぎない形にします。",
      heat: "冷たい飲み物を続けすぎず、常温の水分や軽い汁物を一つ挟みます。",
    },
    avoid: {
      default: "早食い・食べすぎ・冷たい飲み物を重ねて、食後の重さを増やす。",
      damp: "冷たい飲み物、甘いもの、パン・麺中心を重ねて、胃腸の重さを増やす。",
      pressure_down: "脂っこいもの・お酒・食べすぎを重ねて、だるさと胃腸の重さを増やす。",
      cold: "冷たい飲み物や生もの中心で、お腹まわりを内側から冷やす。",
      heat: "暑いからと冷たいものだけで済ませ、胃腸に重さを残す。",
    },
    examples: {
      default: ["味噌汁＋小さめごはん", "軽いスープ", "温かいお茶"],
      damp: ["具だくさん味噌汁", "温かいお茶＋軽め主食", "雑炊"],
      pressure_down: ["軽いスープ＋小さめ主食", "温かいお茶", "味噌汁＋おにぎり"],
      cold: ["雑炊", "卵スープ", "味噌汁＋ごはん"],
      heat: ["野菜スープ", "常温の水分", "梅入りおにぎり"],
    },
    reason: "胃腸の調子が気になる日は、冷たさ・食べすぎ・急いで食べる流れを軽くするほど、食後の重さを残しにくくなります。",
    lifestyle_tip: "食後すぐ座りっぱなしにせず、2〜3分だけ立つか歩く時間を作ります。",
  },
  neck_shoulder: {
    title: {
