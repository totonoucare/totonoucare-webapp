...
function a8({ id, title, clickUrl, imageUrl, impressionUrl, primarySurface, categories, policies, symptoms, weatherFit = [], seasonFit = [], seasonSuppress = [], lifeFit = [], subFit = [], coreFit = [], typeFit = [], priceBands = ["all"], intensity = {}, rewardRank = "medium", riskLevel = "low", buyingBehavior = "official_or_marketplace", reason, tags = [] }) {
  return {
    id,
    source: "a8",
    sourceType: "partner",
