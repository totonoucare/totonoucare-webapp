...
const PROMPT_VERSION = "personal-karte-v4.0-meridian-season-preview-editor";
...
function buildAiKarteFacts(ctx) {
  ...
  return cleanObject({
    ...
    movementChecks: {
      ...
      methodNote: "M-testの要領で、動作時の張り・重さ・動きづらさから、不調の背景にある経絡ラインの負担を探る材料。経絡ラインは、気血水の過不足・偏り、姿勢、冷え、生活負担などが表に出る通り道として扱う。動作負担チェックの動きは軽いセルフチェックとして使え、予報ページのツボ提案にもつながる。",
    },
    seasonSignals: {
...
function buildPrompt(source) {
  return [
    ...
    "- 動作負担チェックは、不調そのものを聞く質問ではなく、動作時の張り・重さ・動きづらさから、不調の背景にある経絡（けいらく）ラインの負担を探る材料です。経絡ラインは、気血水の過不足・偏り、姿勢、冷え、生活負担などが表に出る通り道として扱い、日々のセルフチェックと予報ページのツボ提案につなげます。",
    ...
    "meridian-care：動作負担チェックで探る、不調の背景にある経絡（けいらく）ラインとケア。経絡ラインを不調と同格に並べず、背景にある負担の通り道として説明する。動作チェックの意味、軽いセルフチェック、予報ページのツボ提案との関係まで書く。",
