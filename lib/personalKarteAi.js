...
const PROMPT_VERSION = "personal-karte-v3.5-compact-weather-editor";
...
function buildAiKarteFacts(ctx) {
  ...
  return cleanObject({
    ...
    movementChecks: {
      ...
      methodNote: "M-testの要領で、動作時の張り・重さ・動きづらさから負担がかかる経絡ラインを見る材料。今お困りの不調そのものとは別レイヤー。",
    },
    seasonSignals: {
...
function buildPrompt(source) {
  return [
    ...
    "- コア体質 → 気血津液の偏り → 六淫の負担 → 表に出るサイン → 今日の予報で見ること、という順番を意識します。",
