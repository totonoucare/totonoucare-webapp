...
export function trackAppInitialPageView(){
 try{
  ...
  // Attribution remains available on development hosts; Meta runs only in production.
  if(window.location.hostname!=='mibyo-radar.totonoucare.com')return false;
  ...
  window.__mibyoMetaTrackingVersion='v7.79.78';
  if(!window.fbq){
