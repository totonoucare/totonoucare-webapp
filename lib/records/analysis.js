  ...
  return {
    ...
    forecast: row?.forecast
      ? {
          ...
          why_short: normalizeForecastTimingLanguage(row.forecast.why_short).slice(0, 180),
...
export function snapshotFromForecast(forecast, source = "record_save") {
  ...
  return {
    ...
    why_short: normalizeForecastTimingLanguage(
      forecast.why_short || computedSnapshot.why_short
    ).slice(0, 500),
