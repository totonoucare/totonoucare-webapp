...
export const RECORDS_SUBSCRIPTION_PRODUCT = RECORDS_POLICY.subscription.product;
export const RECORDS_PAID_FEATURES = RECORDS_POLICY.subscription.paidFeatures;
...
export const RECORDS_AI_FREE_CONSULT_TRIAL_LIMIT = RECORDS_POLICY.ai.limits.freeConsultTrial;
export const RECORDS_AI_FREE_CONSULT_MINIMUM_RECORDS = RECORDS_POLICY.ai.limits.freeConsultMinimumRecords;
