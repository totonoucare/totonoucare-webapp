...
export const RECORDS_AI_PRODUCT_CONTEXT = {
  knowledge_version: "records_product_context_v14_care_provenance_2026-09-04",
  ...
  care_model: {
    ...
    live_support_expansion: "ミモルは、表示済みケアと同じ方向性を保ちながら、東洋医学の原則から低リスクな置き換え・追加案を作ってよい。その場合は、アプリが表示したケアとミモルの応用案を言葉で区別する。",
