...
export const RECORDS_AI_PRODUCT_CONTEXT = {
  ...
  weather_model: {
    ...
    explanation_policy: "Ekkenは計算済み値を再計算せず、forecast_reasoningの階層に沿って説明する。気圧ではpressure_directionを物理変化、pressure_response_directionを身体反応として分け、各trigger_factorsのresponse_directionとbody_response_keyを優先する。environmental_cautionsは体質別予報と別の絶対気温注意として扱う。",
  },
  forecast_modes: [
