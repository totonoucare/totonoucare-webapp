...
export const RECORDS_AI_PRODUCT_CONTEXT = {
  knowledge_version: "records_product_context_v8_living_language_2026-07-17",
  ...
  communication_translation: {
    ...
    sensitivity_examples: [
      ...
      { concept: "気滞", example: "力がないというより、出口付近で流れが渋滞している" },
  ...
  weather_model: {
    ...
    pipeline: "固定された体質から天気親和性を作り、当日の6方向の気象ストレスと重ねて有効負担を計算し、主因・副因、体調ゆらぎ度、予報モードへ進む。",
    personalization: "天気親和性はコアタイプ55％、上位の気血津液パターン28％・17％を土台に、環境感受性と環境ベクトルを小さく補正する。有効負担は気象強度×（全員共通分0.30＋体質親和分0.68×本人親和性）。",
