...
export const RECORDS_AI_PRODUCT_CONTEXT = {
  knowledge_version: "records_product_context_v1_2026-07-12",
  ...
  weather_model: {
    ...
    personalization: "有効負担は気象強度に、全員共通分0.30と体質親和分0.68を重ね、余力と過去の気象別レビュー補正を小さく反映する。AIは再計算せず、アプリの計算済み値を事実として使う。",
