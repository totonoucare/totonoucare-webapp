...
const WEATHER_CHANNEL_KEYS = ["pressure_down", "pressure_up", "cold", "heat", "damp", "dry"];
  ...
  return {
    ...
    axes: computed?.axes && typeof computed.axes === "object"
      ? {
          ...
          yin_yang_score: Number.isFinite(Number(computed.axes.yin_yang_score)) ? Number(computed.axes.yin_yang_score) : null,
          drive_score: Number.isFinite(Number(computed.axes.drive_score)) ? Number(computed.axes.drive_score) : null,
        }
      : null,
