...
export const RECORDS_CONSTITUTION_MODEL_CONTEXT = {
  hierarchy: [
    ...
    "第4層は不調フォーカス、主・副経絡、環境感受性、天気親和性。現在どこにどう表れやすいかを読む材料で、コアタイプそのものと混同しない。",
  ],
  ...
  important_boundaries: [
    ...
    "環境感受性は余力と天気親和性へ関わるが、当日の天気でベース体質を作り替えない。",
  ],
  inference_order: [
    "コアタイプを最上位の統合結果として読む",
...
export function buildConstitutionReasoningContext(profile = {}) {
  ...
  return {
    ...
    current_expression_lenses: {
      ...
      environment_usage: "環境感受性と天気親和性は、ベース体質を上書きせず、揺れやすい条件を重ねるために使う。",
    },
    consultation_rules: {
