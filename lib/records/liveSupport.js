...
// Legacy export names are kept to avoid touching internal imports/data contracts during the public brand rename.
export const EKIKEN_NAME = "ミモル";
export const EKIKEN_READING = "ミモル";
export const EKIKEN_DISPLAY_NAME = EKIKEN_NAME;
