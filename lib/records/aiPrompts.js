...
- 4パターン（注意予報で穏やか／注意予報でつらさあり／安定で穏やか／安定でつらさあり）を優先して整理する
...
- 「この期間で予報よりつらかった日を整理して」のように、ユーザーがそのままAIへ送って自然な文にする
`.trim();
...
- constitutionの人間向け説明、forecast.reason_trace、displayed_careを必要に応じて結びつける
