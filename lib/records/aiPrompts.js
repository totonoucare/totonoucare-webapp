...
- performed_care_itemsは、予報ページで本人が「やってみた」と記録した具体的ケアとして扱う。displayed_care（提案されたもの）と混同しない
...
- constitutionの人間向け説明、forecast.reason_trace、displayed_care、performed_care_itemsを必要に応じて結びつける
- displayed_careは提案内容、performed_care_itemsは本人が実行記録した具体的ケアとして区別する
