...
- ingredient_consumed／drink_consumedはconsumed_nameを食べた／飲んだ申告。実行日はsource_date、予報対象日はdate。旧ingredients_or_eating_patternは食材・食べ方の採用。料理例の完食・量・効果は推測せず、保存label・detailに従う。
