...
export const SUB_LABELS = {
  ...
  qi_deficiency: {
    ...
    short: "気虚",
    action_hint:
      "活動と回復に使える余力が少なく、消耗しやすい状態です。無理に動いて発散するよりも、短時間でも横になるなど、まず回復へ回す時間を優先してください。",
  },
  blood_deficiency: {
  ...
  blood_stasis: {
    ...
    short: "血瘀",
    action_hint:
      "局所的なこわばりや、巡りの滞りが残りやすい傾向です。同じ姿勢をこまめに変え、無理のない範囲で体を動かしましょう。冷えを伴うときは、心地よい程度に温めます。",
  },
  fluid_damp: {
    title: "水分代謝が滞り、重だるさが出やすい（痰湿）",
    short: "痰湿",
    action_hint:
      "水分をため込み、重だるさやむくみが出やすい傾向です。甘いものや脂っこいものの重ね食いを控え、体力に合わせて歩くなど、こまめに体を動かしましょう。冷えを伴うときは、冷たいものも控えめに。",
  },
  fluid_deficiency: {
