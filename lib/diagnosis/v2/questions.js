  ...
  },
{
  ...
  type: "freq5",
  title:
    "この2週間で、食後や夕方に「強い眠気／だるさが増える／体が重くなる」と感じた日は何日くらいありますか？",
  options: FREQ5_OPTIONS,
},
  ...
  },
  {
    ...
    type: "multi",
    max: 2,
    title: "天候や環境が変わる前後で、特に影響が出やすい“きっかけ”はどれですか？（最大2つ）",
    options: [
      { label: "気圧の変化（低気圧/前線・台風が近い、天気が崩れる前後）", value: "pressure_shift" },
      { label: "寒暖差（急に冷える/暖かい日が続いた後）", value: "temp_swing" },
      { label: "湿度が上がる（雨/梅雨/蒸し暑さ）", value: "humidity_up" },
      { label: "乾燥が強まる（喉/肌/目が乾きやすい季節・空調）", value: "dryness_up" },
      { label: "強風・冷風（風で冷える/頭痛っぽい）", value: "wind_strong" },
