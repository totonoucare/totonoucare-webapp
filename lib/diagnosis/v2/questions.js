...
export const QUESTIONS_V2 = [
  ...
  },
  {
    ...
    type: "multi",
    max: 2,
    title: "1年の中で、天候が変わる前後に影響が出やすいのはどれですか？（最大2つ）",
    options: [
  ...
  // -------
  {
    ...
    options: [
      { label: "前屈（背中〜腰・脚の後ろがつらい）【腎/膀胱ライン】", value: "A" },
      { label: "反らす（お腹・前ももがつらい）【脾/胃ライン】", value: "B" },
      { label: "体をひねる・横に倒す（脇腹・股関節がつらい）【肝/胆ライン】", value: "C" },
  ...
  },
  {
    ...
    type: "single",
    title:
      "（任意）次にツラさが出やすい動作があれば選んでください（0〜1つ）",
    options: [
      { label: "前屈【腎/膀胱】", value: "A" },
      { label: "反らす【脾/胃】", value: "B" },
      { label: "ひねる/横倒し【肝/胆】", value: "C" },
      { label: "腕上げ/うつむき【心/小腸】", value: "D" },
      { label: "首後屈/回旋【肺/大腸】", value: "E" },
      { label: "腕外転【心包/三焦】", value: "F" },
