  ...
  },
{
  ...
  type: "single",
  title:
    "動作チェック 1/2\n次の2問で、負担が出やすい動きを2つまで選びます。\nまずは、一番ツラさ・張り・違和感が出やすいものを1つ選んでください。\n（無理に伸ばさず、痛みが出る手前でOK）",
  options: [
    { label: "前屈する（背中〜腰・脚の後ろがつらい）", value: "A" },
    { label: "上体を反らす（お腹・前ももがつらい）", value: "B" },
    { label: "体を左右にひねる・側屈する（脇腹・股関節周囲がつらい）", value: "C" },
    { label: "腕を上げる・首をうつむける（肩・肩甲骨まわり）", value: "D" },
    { label: "首を後ろに倒す・横を向く（首・鎖骨まわり）", value: "E" },
    { label: "腕を横から上げる（上肢外側がつらい）", value: "F" },
