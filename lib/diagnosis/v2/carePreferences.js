const CARE_POLICY_DEFINITIONS = {
  ...
  meguraseru: {
    ...
    label: "めぐらせる",
    guide: "滞りをほどき、巡りを保つ",
    body: "軽い動きや呼吸で、詰まり感やこもり感をやわらげます。",
    icon: "/illust/policy/policy-meguraseru.svg",
  },
  nagasu: {
    key: "nagasu",
    label: "ながす",
    guide: "湿気・重だるさ・むくみをためない",
    body: "湿気による重だるさやむくみをためず、体の軽さを保ちやすくします。",
  ...
  uruosu: {
    ...
    label: "うるおす",
    guide: "乾きと消耗を補う",
    body: "目・のど・肌の乾きをいたわり、消耗を重ねにくくします。",
  ...
  sasaeru: {
    key: "sasaeru",
    label: "ささえる",
    guide: "胃腸をいたわり、疲れを増やさない",
    body: "無理に押し切らず、胃腸と回復に使う余力を守ります。",
...
const CORE_POLICY_HINTS = [
  {
    ...
    reason: "無理に押し切らず、回復に使える余力を残すことが大切なタイプです。",
  },
  {
...
const POLICY_PAIR_SUMMARIES = {
  ...
  "shizumeru+uruosu": "熱や高ぶりを落ち着け、乾きと消耗を補う整え方が合いやすいです。",
  "uruosu+shizumeru": "熱や高ぶりを落ち着け、乾きと消耗を補う整え方が合いやすいです。",
