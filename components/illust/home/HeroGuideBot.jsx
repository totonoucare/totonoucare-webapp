        ...
        <svg viewBox="0 0 120 120" className="absolute inset-0 h-full w-full" aria-hidden="true">
          <defs>
            <linearGradient id="headGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="#ecf6f0" />
            </linearGradient>
            <linearGradient id="bodyGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#ddeee5" />
              <stop offset="100%" stopColor="#c7decf" />
            </linearGradient>
            <linearGradient id="radarGlow" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#e2aa3b" stopOpacity="0.9" />
              <stop offset="100%" stopColor="#efbf56" stopOpacity="0.26" />
            </linearGradient>
            <filter id="softShadow" x="-10%" y="-10%" width="120%" height="120%">
              <feDropShadow dx="0" dy="5" stdDeviation="4" floodColor="#355f52" floodOpacity="0.14" />
            </filter>
          </defs>
          <circle cx="60" cy="70" r="40" fill="#ffffff" fillOpacity="0.38" filter="blur(10px)" />
          ...
          <circle cx="60" cy="85" r="6" fill="none" stroke="#ffffff" strokeWidth="1.5" opacity="0.74" />
          <circle cx="60" cy="85" r="3" fill="url(#radarGlow)" />
          <path d="M60 28 L60 18" stroke="#76a690" strokeWidth="2.6" strokeLinecap="round" />
          <path d="M60 18 C52 10, 57 4, 65 4 C72 4, 70 14, 60 18 Z" fill="#9ec9b0" />
          <rect x="24" y="28" width="72" height="52" rx="22" fill="url(#headGrad)" filter="url(#softShadow)" />
          <circle cx="44" cy="50" r="4.5" fill="#567f6a" />
          <circle cx="76" cy="50" r="4.5" fill="#567f6a" />
          <ellipse cx="36" cy="56" rx="5" ry="3" fill="#e2b4b4" opacity="0.44" />
          <ellipse cx="84" cy="56" rx="5" ry="3" fill="#e2b4b4" opacity="0.44" />
          <path d="M54 58 C 58 61, 62 61, 66 58" fill="none" stroke="#567f6a" strokeWidth="2.25" strokeLinecap="round" />
        </svg>
      </div>
    </div>
  );
