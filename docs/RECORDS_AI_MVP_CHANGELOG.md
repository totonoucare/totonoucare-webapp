...
| `components/records/ForecastActualMap.jsx` | 予報負担×実際のつらさの比較マップ |
...
| `lib/records/analysis.js` | 3段階比較、集計、天気・ケア反復、チャート点、基本分析、スナップショット |
| `lib/records/server.js` | DB読込、旧スキーマ互換、期間検証、送信用匿名化・ハッシュ |
...
| ファイル | 役割 |
|---|---|
| `tests/records-analysis.test.mjs` | 9組合せ、予報なし、互換タグ、要約、週集計、マップ、スナップショット |
