...
function HomeStateCta({ loading, hasResult, hasLocation, core, coreCode, subs = [], onPrimary, onSecondary }) {
  ...
  let title = "体質トリセツを作る";
  let body = "4〜6分で、体質のクセを多面的に整理。基本14問、回答に応じた追加0〜4問、最後の確認1問から、張りつめやすさ、だるさや冷えの出やすさ、負担を受け止める余力、巡りや潤い、負担が出やすい体のラインまで読み解きます。この結果をもとに、今日・明日の体調予報と、暮らす・食べる・ほぐすのケアをあなた向けに整えます。";
