      ...
      <div className="relative z-10 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-[14px] font-bold leading-6 text-[#5b6674]">
            4〜6分を目安に、全15〜19問へ回答。体質の反応方向、余力、巡りや潤い、負担が出やすい体のラインを整理し、今日・明日の体調予報とケアへ反映します。
          </p>
        </div>
      </div>
...
function HomeStateCta({ loading, hasResult, hasLocation, core, coreCode, subs = [], onPrimary, onSecondary }) {
  ...
  let title = "体質トリセツを作る";
  let body = "4〜6分を目安に、全15〜19問へ回答。体質の反応方向、余力、巡りや潤い、負担が出やすい体のラインを整理し、今日・明日の体調予報とケアへ反映します。";
