...
const pageDescription =
  "体質トリセツ、今日・明日の体調予報、対策ケア、実感記録、ケアナビAI Ekkenへの体調相談、自分に合う整え方の振り返り、国家資格者によるオンライン相談までをまとめたガイドです。";
  ...
  step: [
    {
      "@type": "HowToStep",
      name: "体質トリセツを作る",
      text: "質問に答えて、ベース体質、気血水の6つの傾向、寒熱、天気との相性を整理します。体のラインは結果後に任意で追加できます。",
    },
    {
      "@type": "HowToStep",
      name: "今日と明日の体調予報を見る",
      text: "体調警戒度と安定・いたわり・守りのモードから、その日にどのくらい備えるかを確認します。",
    },
    {
      "@type": "HowToStep",
      name: "対策ケアで先回りする",
