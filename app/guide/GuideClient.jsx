        ...
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <GuideCard tone="teal" title="必要な時のサポート" icon={<IconCare />} compact>
              パーソナルケアショップでは、体質・不調・使いどきに合う用品や食品を探せます。セルフケアだけでは足りない不調には、国家資格者によるオンライン相談を準備しています。振り返りを使っていなくても相談できます。
            </GuideCard>
        ...
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <GuideCard tone="teal" title="国家資格者によるオンライン相談" icon={<IconBodyLine />}>
              不調が長引く、検査では異常が見つからないのにつらい、アプリの軽いセルフケアだけでは足りない。そんな時に、人へ直接相談できる別サービスを準備しています。AIによる振り返りの続きではありません。
              <CheckList
                items={[
