        ...
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <MiniNote label="AIへ送る情報">
              振り返りとEkken相談では、解釈済みの体質トリセツ、利用する画面に必要な予報・表示ケア・実行ケア・実感・メモ・会話を使います。期間の振り返りと今の相談は別の会話として扱います。アカウントに登録された氏名・メールアドレス・住所と、体質チェックの生回答は自動送信しません。ただし、記録メモや会話欄に自分で入力した内容は、そのまま送信対象になります。
            </MiniNote>
