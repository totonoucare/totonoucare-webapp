        ...
        <div className="relative overflow-hidden rounded-[32px] bg-[#EFF8F4] px-5 py-6 ring-1 ring-[#CFE7DE] shadow-[0_18px_45px_-34px_rgba(47,129,110,0.38)] sm:px-6 sm:py-7">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-3.5 text-[14px] font-bold leading-6 text-slate-700">
              体質と天気から今日・明日の体調予報を確認し、できそうなケアだけ試します。夜に実感を残すと、どんな日に何をすると過ごしやすかったかが少しずつ見えてきます。
            </div>
      ...
      {tab === "flow" ? (
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <FlowItem num="1" title="今日・明日の体調予報を見る">
            ...
            <FlowItem num="4" title="自分に合う整え方を見る">
              グラフや振り返りで、体調が崩れやすかった日、先回りして試したケア、実際の体調を見比べます。どんな日に何をすると過ごしやすかったか、次に試すことを整理できます。
            </FlowItem>
            ...
            <GuideCard tone="teal" title="必要な時のサポート" icon={<IconCare />} compact>
              パーソナルケアショップでは、体質・不調・使いどきに合う用品や食品を探せます。体質チェックや記録をもとに、鍼灸師とツボ・お灸・ストレッチのやり方を確かめるオンライン相談も準備しています。
            </GuideCard>
      ...
      {tab === "radar" ? (
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <GuideCard tone="violet" title="ケアナビAI ミモルの役割" icon={<IconSpark />}>
              ミモルは、未病レーダーが体質と天気から選んだケアを分かりやすく案内します。予報モードに合わせて表情が変わり、ケアを記録すると安心した表情になります。
            </GuideCard>
      ...
      {tab === "records" ? (
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <GuideCard tone="indigo" title="グラフは3段で見る" icon={<IconAnalysis />}>
              ...
              <CheckList
                items={[
                  ...
                  "いたわり・守り予報でも体調○などの絞り込みで、振り返りたい日を探せます。",
                ]}
              />
            </GuideCard>
            ...
            <GuideCard tone="violet" title="この振り返りについてミモルに聞く" icon={<IconAnalysis />}>
              分析した期間の記録だけを引き継ぎ、気になった日、天気ストレス、ケアの種類やタイミングを追加で質問できます。
            </GuideCard>

            <GuideCard tone="mint" title="今の調子をミモルに相談" icon={<IconSpark />}>
              体調が気になった瞬間は、相談タブからケアナビAI ミモルへ一言から話せます。今日・明日の予報、今日行ったケア、直近の記録を見ながら、今できることを一緒に整理します。
              <CheckList
                items={[
            ...
            <GuideCard tone="teal" title="鍼灸師とのオンライン相談（準備中）" icon={<IconBodyLine />}>
              自宅から鍼灸師（国家資格者）と相談し、自分に合うケアを具体的に確かめるサービスを準備しています。
              <CheckList
                items={[
                  "共有したい体質チェック・記録・AIの振り返りをもとに整理し、説明を繰り返す負担を軽くします。",
                  "ツボの位置と触れ方、お灸やシール鍼の使い方を画面越しに確認します。",
                  "ラインのストレッチなどを一緒に確かめ、日々続けられるケアに整えます。",
                ]}
              />
            </GuideCard>

            <MiniNote label="AIへ送る情報">
              振り返りとミモル相談では、解釈済みの体質トリセツ、利用する画面に必要な予報・表示ケア・実行ケア・実感・メモ・会話を使います。期間の振り返りと今の相談は別の会話として扱います。アカウントに登録された氏名・メールアドレス・住所と、体質チェックの生回答は自動送信しません。ただし、記録メモや会話欄に自分で入力した内容は、そのまま送信対象になります。
            </MiniNote>
        ...
        <Module className="bg-white p-5 ring-1 ring-[#DCE8DD] shadow-[0_18px_42px_-34px_rgba(15,23,42,0.34)] sm:p-6">
          ...
          <div className="space-y-4">
            <GuideCard tone="mint" title="予報ページとの違い" icon={<IconRadar />}>
              予報ページは、今日・明日に行う対策ケアを確認し、実行を記録する場所です。ショップは、そのケアに役立つ商品を選び、購入する場所です。
              <CheckList
                items={[
            ...
            <GuideCard tone="mint" title="気になる商品と購入済み商品" icon={<IconSpark />}>
              比べたい商品は「気になる」に保存できます。購入後に「購入済み」にすると、体調予報の対策ケアに手持ちアイテムとして表示されます。
            </GuideCard>

            <GuideCard tone="violet" title="買う前に、まず目的を確認" icon={<IconBowl />}>
              商品を使った記録はショップではなく、体調予報の対策ケアから行います。食品は「今日取り入れた」、用品やほぐす道具は「今日使った」として記録されます。
            </GuideCard>

            <MiniNote>
              体調予報で今日のケアを確認し、必要な道具や食品をショップで選ぶ。購入後は対策ケアから実行を記録する、という流れです。
            </MiniNote>
