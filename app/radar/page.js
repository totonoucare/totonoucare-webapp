...
function getGaugeTone(signal) {
  if (signal === 2) {
    return {
      stroke: "#D97A3A",
      ring: "#E4AA78",
      ringSoft: "rgba(217,122,58,0.22)",
      inner: "#FBEBDD",
      fillStart: "rgba(252,236,220,0.98)",
      fillEnd: "rgba(217,122,58,0.92)",
      shadow: "rgba(217,122,58,0.14)",
      main: "#B85F2F",
      labelText: "#8F4A24",
      labelBg: "rgba(255,255,255,0.96)",
      labelBorder: "rgba(217,122,58,0.26)",
      labelShadow: "rgba(217,122,58,0.12)",
    };
  }
  ...
  if (signal === 1) {
    return {
      stroke: "#D8A23A",
      ring: "#E6C06A",
      ringSoft: "rgba(216,162,58,0.22)",
      inner: "#FCF1D9",
      fillStart: "rgba(253,245,219,0.98)",
      fillEnd: "rgba(216,162,58,0.92)",
      shadow: "rgba(216,162,58,0.14)",
      main: "#A87719",
      labelText: "#875F14",
      labelBg: "rgba(255,255,255,0.96)",
      labelBorder: "rgba(216,162,58,0.26)",
      labelShadow: "rgba(216,162,58,0.12)",
    };
  }
  ...
  return {
    stroke: "#58AE96",
    ring: "#8BC9B8",
    ringSoft: "rgba(88,174,150,0.22)",
    inner: "#DDF4EC",
    fillStart: "rgba(226,247,239,0.98)",
    fillEnd: "rgba(88,174,150,0.92)",
    shadow: "rgba(88,174,150,0.14)",
    main: "#2F7E68",
    labelText: "#296E5C",
    labelBg: "rgba(255,255,255,0.96)",
    labelBorder: "rgba(88,174,150,0.24)",
    labelShadow: "rgba(88,174,150,0.12)",
  };
}
