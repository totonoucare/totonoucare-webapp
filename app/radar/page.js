...
function getGaugeTone(signal) {
  if (signal === 2) {
    return {
      stroke: "#b76e79",
      ring: "#c98a92",
      ringSoft: "rgba(183, 110, 121, 0.18)",
      inner: "#f6e9ea",
      fillStart: "rgba(246, 233, 234, 0.98)",
      fillEnd: "rgba(183, 110, 121, 0.92)",
      shadow: "rgba(183, 110, 121, 0.10)",
      main: "#8f4f59",
      labelText: "#7a3f48",
      labelBg: "rgba(255,255,255,0.96)",
      labelBorder: "rgba(183, 110, 121, 0.24)",
      labelShadow: "rgba(183, 110, 121, 0.08)",
    };
  }
  ...
  if (signal === 1) {
    return {
      stroke: "#b78a52",
      ring: "#c9a06a",
      ringSoft: "rgba(183, 138, 82, 0.18)",
      inner: "#f6edde",
      fillStart: "rgba(246, 237, 222, 0.98)",
      fillEnd: "rgba(183, 138, 82, 0.92)",
      shadow: "rgba(183, 138, 82, 0.10)",
      main: "#8a6438",
      labelText: "#76532d",
      labelBg: "rgba(255,255,255,0.96)",
      labelBorder: "rgba(183, 138, 82, 0.24)",
      labelShadow: "rgba(183, 138, 82, 0.08)",
    };
  }
  ...
  return {
    stroke: "#5f8f7a",
    ring: "#7cab97",
    ringSoft: "rgba(95, 143, 122, 0.18)",
    inner: "#e9f3ee",
    fillStart: "rgba(233, 243, 238, 0.98)",
    fillEnd: "rgba(95, 143, 122, 0.92)",
    shadow: "rgba(95, 143, 122, 0.10)",
    main: "#3f6f5d",
    labelText: "#345a4b",
    labelBg: "rgba(255,255,255,0.96)",
    labelBorder: "rgba(95, 143, 122, 0.24)",
    labelShadow: "rgba(95, 143, 122, 0.08)",
  };
}
