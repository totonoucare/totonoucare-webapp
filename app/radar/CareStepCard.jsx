export default function CareStepCard({ action, actionButton }) {
  ...
  return (
    <div className="mt-3 rounded-[17px] bg-white px-4 py-3 ring-1 ring-[#E1E6E1]">
      ...
      {action.felt_sense ? <div className="mt-3 rounded-[14px] bg-[#F4FAF7] px-3 py-2 text-[13px] font-bold leading-6 text-slate-600"><span className="font-black text-[#2F816E]">試したあとの目安　</span>{action.felt_sense}</div> : null}
