...
// v7.43: 安定日のサインは語尾合成せず、安定専用の完成文として持つ。
...
const RADAR_NARRATIVE_STABLE_SIGN_BY_SYMPTOM = {
  fatigue: [
    "動き出しの重さは、午前のうちに少し整えれば残りにくい",
    "午後の重だるさは、休憩を一つ入れれば軽めで済みそう",
    "休んだ後の重さは、今日は深追いしなくてよさそう",
  ],
  sleep: [
    "頭の冴えは、夕方から光を少し減らせば残りにくい",
    "画面を見た後の休まりにくさは、早めに区切れば軽めで済みそう",
    "胃腸の重さは、夜に足しすぎなければ睡眠まで引っぱりにくい",
  ],
  digestion: [
    "食後の重さは、量を少し軽くすれば残りにくい",
    "お腹の張りは、温かい汁物かお茶を足せば落ち着きやすい",
    "胃腸のもたつきは、冷たいものを続けなければ軽めで済みそう",
  ],
  neck_shoulder: [
    "首肩の重さは、早めにほどけば残りにくい",
    "首すじの疲れは、画面を区切れば軽めに戻しやすい",
    "肩の戻りにくさは、耳まわりを動かすくらいで見ておく",
  ],
  low_back_pain: [
    "腰まわりの重さは、座りっぱなしを一度切れば残りにくい",
    "立ち上がりの重さは、骨盤を小さく動かせば戻しやすい",
    "腰腹の負担は、足もとを冷やさなければ軽めで済みそう",
  ],
  swelling: [
    "夕方の足首の重さは、足首を少し動かせば残りにくい",
    "顔や脚のむくみは、冷たさと塩気を重ねなければ軽めで済みそう",
    "水分の重さは、同じ姿勢を切れば見ておくくらいでよさそう",
  ],
  headache: [
    "頭・目・耳まわりの重さは、画面を区切れば残りにくい",
    "首肩から頭へのこわばりは、早めにゆるめれば軽めで済みそう",
    "頭の混み合いは、空腹と画面刺激を重ねなければ戻しやすい",
  ],
  dizziness: [
    "立ち上がりのふわつきは、一呼吸置けば軽めで済みそう",
    "動き出しの揺れは、急がなければ残りにくい",
    "首や耳まわりの緊張は、今日は短くゆるめるくらいでよさそう",
  ],
  mood: [
    "気分の重さは、体の重さを一つ減らせば戻しやすい",
    "焦りは、最初の一つに絞れば軽めで済みそう",
    "起動に時間がかかる時も、今日は深追いしなくてよさそう",
  ],
  default: [
    "小さな違和感は、早めに一息入れれば残りにくい",
    "注意時間の重さは、無理に押さなければ軽めで済みそう",
    "今日は強い対策より、軽く整えるくらいでよさそう",
  ],
};

const RADAR_NARRATIVE_STABLE_WEATHER_POINT = {
  damp: "湿気の重さは、空気を入れ替えれば軽めで済みそう",
  pressure_down: "頭・耳・首のこもりは、今日は長引きにくい見込み",
  pressure_up: "前のめり感は、深呼吸ひとつで戻しやすい日",
  cold: "冷えからくるこわばりは、入口を守れば残りにくい",
  heat: "上にこもる熱っぽさは、涼しさと水分で軽めに逃がせそう",
  dry: "目・のど・肌のカサつきは、水分と休憩で戻しやすい",
};
