...
function getTsuboRegionKey(point) {
  ...
  if (region === "abdomen" || region === "chest_abdomen" || region === "trunk") {
    return "trunk";
  }
...
function HandWristIcon({ className }) {
  return (
    <IconFrame className={className}>
      ...
      />
      <path
        d="M58,177 L58,139 C58,129 66,121 76,121 C86,121 94,129 94,139 L94,169 C94,180 101,188 112,188 L146,188 C165,188 181,172 181,153 L181,103 C181,93 189,85 199,85 C209,85 217,93 217,103 L217,157 C217,198 187,223 146,223 L104,223 C78,223 58,203 58,177 Z"
        fill="#F8DDCF"
        stroke="#8A6F61"
        strokeWidth={8}
        strokeLinecap="round"
